webpackJsonp([5], [function (e, t, i) {
    ...
    function a(e) {
        o(), u["default"].postPageLength(), u["default"].preload.onReady(function () {
            I["default"].pageStart(), u["default"].showPPT()
    ...
    var s = i(4),
        ...
        P = i(91),
        I = n(P);
    window.location.href.indexOf(".lviewer.maka.im") > 0 && (window.location.href = "http://viewer.off.61xiangce.com/viewer/offline"), y["default"].send("homeStart"), h["default"].judgeShowAd() || h["default"].inIframe() || !h["default"].isMAKA() || w["default"].init(window.projectVersion), $(window).on("touchmove", function (e) {
        e.preventDefault()
    }), h["default"].judgePC() && h["default"].isMAKA() && (window.location.href = window.projectVersion.pcViewerUrl);
    var E = {
        lastCallback: function () {
            h["default"].getUrlParameter("answerid") || (I["default"].lastPage(), h["default"].judgeShowAd() ? C["default"].showGoogleAD() : A["default"].showAD({
                replay: function () {
        ...
        pageChangeCallback: function () {
            I["default"].pageChange(u["default"].currentPageIndex), u["default"].currentPageIndex === f["default"].getPageLength() - 1 && (h["default"].judgeShowAd() ? C["default"].loadStart() : A["default"].loadStart())
        }
    };
    u["default"].setOption(E), l["default"].setProjectId(window.projectVersion.id), m["default"].isLocal() ? window.localView = function (e) {
    ...
    var a = function () {
        ...
        l = function () {
            function e() {
                o(this, e), this.host = "/", this.examResultPage = -1, this.voteData = null, this.needWxLogin = !1, this.hasVote = !1
            }
            return a(e, [{
                ...
                value: function (e, t, i) {
                    ...
                    return e.indexOf("pub.idqqimg") >= 0 || e.indexOf("pub.idqqimg") >= 0 || !this.isAppNormalMode() ? e : (n = this.isIOS() || this.isFF() ? "80Q." + o : ".webp", e + "@" + a + n)
                }
            }, {
                key: "getUid",
                value: function () {
        ...
        u = function () {
            function e() {
                o(this, e), this.canvas = {
                    standardWidth: 640,
                    standardHeight: 1008
                }, "production" === this.getEnvironment() ? (this.ADtransHost = "http://chuanbo.maka.im", this.urlHost = "http://viewer.maka.im", this.apiHost = "http://api.maka.im", this.platHost = "http://www.maka.im", this.reportUrl = "http://newadmin.maka.mobi/api/witnesses") : (this.ADtransHost = "http://test.chuanbo.maka.im", this.urlHost = "http://test.viewer.maka.im", this.apiHost = "http://test.maka.im", this.platHost = "http://test.www.maka.im", this.reportUrl = "http://test.newadmin.maka.mobi/api/witnesses"), this.postFormUrl = this.apiHost + "/api/form/", this.newPostFormUrl = this.apiHost + "/api/v4/new_form/", this.eventClickUrl = this.apiHost + "/api/eventClick", this.glassBreakVoice = "http://res2.maka.im/cdn/maka/effects/glassbreak.mp3", this.engFontUrl = "http://global-maka-public.oss-cn-beijing.aliyuncs.com/fonts/", this.cdnUrl = "http://res2.maka.im/cdn/maka/release/", this.language = {
                    submitForm: "æäº¤",
                    submiting: "æäº¤ä¸­...",
                    submited: "å·²æäº¤",
                    pleaseInput: "è¯·è¾“å…¥",
                    emptyForm: "è¡¨å•ä¸èƒ½å…¨ä¸ºç©º",
                    submitSuccess: "æäº¤æˆåŠŸ!",
                    wrongFormat: "æ ¼å¼ä¸æ­£ç¡®",
                    submitFail: "ç½‘ç»œä¸ç»™åŠ›å“¦ï½žè¯·ç¨åŽå†è¯•!"
                }, this.wxCookie = "functionOpenId2", this.voteTypeCookie = "vote_type"
            }
            return a(e, [{
                key: "isAdDebug",
                value: function () {
                ...
                key: "addCrop",
                value: function (e, t) {
                    var i = t.left < 0 || !t.left ? 0 : t.left,
                        n = t.top < 0 || !t.top ? 0 : t.top,
                        o = t.width < 0 || !t.width ? 0 : t.width,
                        a = t.height < 0 || !t.height ? 0 : t.height,
                        r = void 0;
                    return e.indexOf("aliyuncs") >= 0 && (e = e.replace("maka-test.oss-cn-beijing.aliyuncs.com", "test.img.maka.im")), r = c["default"].isIOS() || c["default"].isFF() ? ".src" : ".webp", e + "@" + i + "-" + n + "-" + o + "-" + a + "a_90Q" + r
                }
            }, {
                key: "isGif",
                value: function (e) {
                ...
                value: function () {
                    ...
                    if (t = this.isAppNormalMode() ? window.projectVersion.p_version : (new Date).getTime(), this.isTemplate()) {
                        if (this.isStoreTemplatePreview() || this.isRemoveDesignerAd()) e = "/api/storeTemplate/" + i + "?dataType=pdata&v=" + t;
                            ...
                            if (!this.isVersionedTemplatePreview()) return e = "/user/" + o + "/template/" + i + "/" + i + "_v" + t + ".json", "test" === n || "development" === n ? e = "http://maka-test.oss-cn-beijing.aliyuncs.com" + e : "production" === n && (e = "http://res.maka.im" + e), e;
                            var a = s["default"].getUrlParameter("version");
                            a = a ? "&version=" + a : "", e = "/api/requestVersionedTemplate/" + i + "?dataType=pdata&v=" + t + a
                        }
                        return "aliyun" !== s["default"].getUrlParameter("env") && ("test" === n ? e = "http://test.api.maka.im" + e : "production" === n && (e = "http://api.maka.im" + e)), e
                    }
                    return this.isAppNormalMode() ? (e = "/user/" + o + "/event/" + i + "/" + i + "_v" + t + ".json", "test" === n || "development" === n ? e = "http://maka-test.oss-cn-beijing.aliyuncs.com" + e : "production" === n && (e = "http://res.maka.im" + e)) : (e = "/api/event/" + i + "?dataType=all&ts=" + t, "test" === n ? e = "http://test.api.maka.im" + e : "production" === n && (e = "http://api.maka.im" + e)), e
                }
            }, {
                key: "getEnvironment",
                value: function () {
    ...
    function a(e, t, i) {
        console.log("jdkready"), "undefined" != typeof e && e.ready(function () {
            e.onMenuShareAppMessage({
                ...
                configUrl: "",
                success: function () {
                    "undefined" != typeof DS && DS.sendRepost("appMessage"), window.statisticSDK.countShare("appMessage"), b["default"].ADTansGuide()
                },
                cancel: function () {}
                ...
                imgUrl: t.thumb,
                success: function () {
                    "undefined" != typeof DS && DS.sendRepost("timeline"), window.statisticSDK.countShare("timeline"), b["default"].ADTansGuide()
                },
                cancel: function () {}
            }), e.onMenuShareQQ({
                title: t.title,
                ...
                imgUrl: t.thumb,
                success: function () {
                    "undefined" != typeof DS && DS.sendRepost("QQ"), window.statisticSDK.countShare("other")
                },
                cancel: function () {}
            }), e.onMenuShareWeibo({
                title: t.title,
                ...
                imgUrl: t.thumb,
                success: function () {
                    "undefined" != typeof DS && DS.sendRepost("Weibo"), window.statisticSDK.countShare("other")
                },
                cancel: function () {}
            })
        })
    ...
    function s(e) {
        window.Config.isTurnOffOssCrop() || (e.thumb.indexOf("@") > 0 ? e.thumb = e.thumb + "_100w" : e.thumb = e.thumb + "@100w")
    }
    ...
    function l(e) {
        s(e), r(e, function (e) {
            ...
            e.link = i = window.location.host + "/k/" + e.id, n && (e.link = e.link + "?task_id=" + p["default"].getUrlParameter("task_id") + "&member_id=" + p["default"].getUrlParameter("member_id")), o(t, e), a(t, e), "undefined" != typeof DS && DS.ready(function () {
                ...
                window.projectVersion.titleMust && (e.title = window.projectVersion.titleMust), o(window.wx, e), a(window.wx, e)
            })
        })
    }
    ...
    function c(e, t) {
        ...
        a(window.wx, i, !t), "undefined" != typeof DS && DS.ready(function () {
            if (i.link = DS.linkChange(n), o && (i.link = i.link + "&task_id=" + p["default"].getUrlParameter("task_id") + "&member_id=" + p["default"].getUrlParameter("member_id")), window.projectVersion.urlParam)
            ...
            window.projectVersion.titleMust && (i.title = window.projectVersion.titleMust), a(window.wx, i, !t)
        })
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var a = function () {
        ...
        u = function () {
            function e() {
                o(this, e), this.waitingReq = [], c["default"].isAppNormalMode() && window.statisticSDK && window.statisticSDK.setData({
    ...
    ! function (o, a, r, s) {
        ...
        function d(e, t, i) {
            ...
            return function () {
                ...
                return a && a.call(o.console, n, i), e.apply(this, arguments)
            }
        }

        function f(e, t, i) {
            var n, o = t.prototype;
            n = e.prototype = Object.create(o), n.constructor = e, n._super = o, i && ge(n, i)
        }
        ...
        function j(e) {
            ...
            return new(t = i ? i : Ee ? V : je ? Q : Ie ? Y : L)(e, S)
        }
        ...
        function S(e, t, i) {
            var n = i.pointers.length,
                ...
                a = t & Ue && n - o === 0,
                r = t & (ze | Be) && n - o === 0;
            i.isFirst = !!a, i.isFinal = !!r, a && (e.session = {}), i.eventType = t, D(e, i), e.emit("hammer.input", i), e.recognize(i), e.session.prevInput = i
        }
        ...
        function D(e, t) {
            var i = e.session,
                n = t.pointers,
                o = n.length;
            i.firstInput || (i.firstInput = R(t)), o > 1 && !i.firstMultiple ? i.firstMultiple = R(t) : 1 === o && (i.firstMultiple = !1);
            var a = i.firstInput,
                r = i.firstMultiple,
                s = r ? r.center : a.center,
                l = t.center = U(n);
            t.timeStamp = ke(), t.deltaTime = t.timeStamp - a.timeStamp, t.angle = N(s, l), t.distance = B(s, l), T(i, t), t.offsetDirection = z(t.deltaX, t.deltaY);
            var c = M(t.deltaTime, t.deltaX, t.deltaY);
            t.overallVelocityX = c.x, t.overallVelocityY = c.y, t.overallVelocity = ye(c.x) > ye(c.y) ? c.x : c.y, t.scale = r ? H(r.pointers, n) : 1, t.rotation = r ? F(r.pointers, n) : 0, t.maxPointers = i.prevInput ? t.pointers.length > i.prevInput.maxPointers ? t.pointers.length : i.prevInput.maxPointers : t.pointers.length, O(i, t);
            var u = e.element;
        ...
        function O(e, t) {
            ...
            if (t.eventType != Be && (l > Re || r.velocity === s)) {
                var c = t.deltaX - r.deltaX,
                    u = t.deltaY - r.deltaY,
                    d = M(l, c, u);
                n = d.x, o = d.y, i = ye(d.x) > ye(d.y) ? d.x : d.y, a = z(c, u), e.lastInterval = t
            } else i = r.velocity, n = r.velocityX, o = r.velocityY, a = r.direction;
            t.velocity = i, t.velocityX = n, t.velocityY = o, t.direction = a
        }
        ...
        function L() {
            this.evEl = Ge, this.evWin = Ze, this.pressed = !1, E.apply(this, arguments)
        }

        function V() {
            this.evEl = $e, this.evWin = et, E.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function q() {
            this.evTarget = it, this.evWin = nt, this.started = !1, E.apply(this, arguments)
        }

        function J(e, t) {
            var i = A(e.touches),
                n = A(e.changedTouches);
            return t & (ze | Be) && (i = x(i.concat(n), "identifier", !0)), [i, n]
        }

        function Q() {
            this.evTarget = at, this.targetIds = {}, E.apply(this, arguments)
        }

        function W(e, t) {
            var i = A(e.touches),
                n = this.targetIds;
            if (t & (Ue | Me) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            ...
            for (o = 0; o < r.length;) n[r[o].identifier] && s.push(r[o]), t & (ze | Be) && delete n[r[o].identifier], o++;
        ...
        function Y() {
            ...
            this.touch = new Q(this.manager, e), this.mouse = new L(this.manager, e), this.primaryTouch = null, this.lastTouches = []
        }

        function K(e, t) {
            e & Ue ? (this.primaryTouch = t.changedPointers[0].identifier, G.call(this, t)) : e & (ze | Be) && G.call(this, t)
        }
        ...
        function ee(e) {
            this.options = ge({}, this.defaults, e || {}), this.id = P(), this.manager = null, this.options.enable = g(this.options.enable, !0), this.state = vt, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function fe(e, t) {
            this.options = ge({}, de.defaults, t || {}), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = e, this.input = j(this), this.touchAction = new X(this, this.options.touchAction), pe(this, !0), u(this.options.recognizers, function (e) {
        ...
        function pe(e, t) {
            ...
            if (i.style) {
                ...
                u(e.options.cssProps, function (o, a) {
                    n = C(i.style, a), t ? (e.oldCssProps[n] = i.style[n], i.style[n] = o) : i.style[n] = e.oldCssProps[n] || ""
                }), t || (e.oldCssProps = {})
            }
        }
        ...
        var Ae = d(function (e, t, i) {
                for (var n = Object.keys(t), o = 0; o < n.length;)(!i || i && e[n[o]] === s) && (e[n[o]] = t[n[o]]), o++;
                return e
            }, "extend", "Use `assign`."),
            xe = d(function (e, t) {
                return Ae(e, t, !0)
        ...
        E.prototype = {
            ...
            destroy: function () {
                this.evEl && v(this.element, this.evEl, this.domHandler), this.evTarget && v(this.target, this.evTarget, this.domHandler), this.evWin && v(I(this.element), this.evWin, this.domHandler)
            }
        };
        var Ke = {
                mousedown: Ue,
        ...
        f(L, E, {
            handler: function (e) {
                var t = Ke[e.type];
                t & Ue && 0 === e.button && (this.pressed = !0), t & Me && 1 !== e.which && (t = ze), this.pressed && (t & ze && (this.pressed = !1), this.callback(this.manager, t, {
                    pointers: [e],
                    changedPointers: [e],
                    pointerType: Te,
                    srcEvent: e
        ...
        o.MSPointerEvent && !o.PointerEvent && ($e = "MSPointerDown", et = "MSPointerMove MSPointerUp MSPointerCancel"), f(V, E, {
            handler: function (e) {
                var t = this.store,
                    i = !1,
                ...
                o & Ue && (0 === e.button || r) ? 0 > s && (t.push(e), s = t.length - 1) : o & (ze | Be) && (i = !0), 0 > s || (t[s] = e, this.callback(this.manager, o, {
                    pointers: t,
                    changedPointers: [e],
                    pointerType: a,
                    srcEvent: e
        ...
        f(q, E, {
            handler: function (e) {
                ...
                if (t === Ue && (this.started = !0), this.started) {
                    ...
                    t & (ze | Be) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, t, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: Se,
                        srcEvent: e
        ...
        ee.prototype = {
            ...
            emit: function (e) {
                ...
                var i = this,
                    n = this.state;
                yt > n && t(i.options.event + te(n)), t(i.options.event), e.additionalEvent && t(e.additionalEvent), n >= yt && t(i.options.event + te(n))
            },
            tryEmit: function (e) {
            ...
            getTouchAction: function () {
                var e = this.options.direction,
                    t = [];
                return e & qe && t.push(gt), e & Je && t.push(ht), t
            },
            directionTest: function (e) {
                var t = this.options,
                    ...
                    a = e.deltaX,
                    r = e.deltaY;
                return o & t.direction || (t.direction & qe ? (o = 0 === a ? Ne : 0 > a ? Fe : He, i = a != this.pX, n = Math.abs(e.deltaX)) : (o = 0 === r ? Ne : 0 > r ? Le : Ve, i = r != this.pY, n = Math.abs(e.deltaY))), e.direction = o, i && n > t.threshold && o & t.direction
            },
            attrTest: function (e) {
            ...
            process: function (e) {
                ...
                else if (e.eventType & Ue) this.reset(), this._timer = l(function () {
            ...
            attrTest: function (e) {
                ...
                return i & (qe | Je) ? t = e.overallVelocity : i & qe ? t = e.overallVelocityX : i & Je && (t = e.overallVelocityY), this._super.attrTest.call(this, e) && i & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && ye(t) > this.options.velocity && e.eventType & ze
            },
            emit: function (e) {
            ...
            recognize: function (e) {
                ...
                if (!t.stopped) {
                    ...
                    var i, n = this.recognizers,
                        o = t.curRecognizer;
                    (!o || o && o.state & kt) && (o = t.curRecognizer = null);
                    for (var a = 0; a < n.length;) i = n[a], t.stopped === Pt || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(e), !o && i.state & (wt | bt | yt) && (o = t.curRecognizer = i), a++
                }
            },
            get: function (e) {
            ...
            return a(e, [{
                ...
                value: function () {
                    ...
                    return new d["default"](function (t, i) {
                        // get JSON
                        console.log('dist/tlc/mobile/assets/data.json'), s["default"].ajax({
                            type: "GET",
                            cache: false,
                            dataType: "json",
                            url: 'dist/tlc/mobile/assets/data.json',
                            success: function (i) {
                ...
                key: "localInt",
                value: function (e) {
                    return this.pdata = e.data.pdata, this.contentJSON = e.data.pdata.json, this.music = e.data.pdata.music, this.menu = e.data.pdata.menu, d["default"].resolve(this.contentJSON)
                }
            }, {
                key: "hasPage",
                value: function (e) {
                ...
                value: function (e) {
                    ...
                    throw "MAKA EXCEPTION: indexä¸åˆæ³•"
                }
            }, {
                key: "getPageLength",
                value: function () {
    ...
    ! function (t, i) {
        ...
        var r = function (e, t, i) {
            ...
            s = function (e, t, i) {
                if (!e) return e;
                var n = W(e);
                Q(e.delay) && (n.delay = e.delay(t, i)), Q(e.callback) && (console.log("DeprecationWarning: callback is renamed to complete"), n.complete = function () {
                    e.callback.call(this, t, i)
                });
                var o = Q(e.allDone),
                    a = Q(e.complete);
                (a || o) && (n.complete = function () {
                    a && e.complete.call(this, t, i), o && t == i - 1 && e.allDone()
            ...
            l = function (e, i, n) {
                function o(i) {
                    return v.tick(i), v.updateElement(e), v.isStopped() ? void 0 : v.completed() ? void(a.loop > 1 && !v.isStopped() ? (a.loop -= 1, v.restart(), w(o)) : (a.complete && a.complete.call(e), b.length && (a = b.pop(), l = g(a, d, !0), d = g(a, W(d)), a = m(l, d, a), v = y(a, e), t.push([e, v]), v.tick(i), w(o)))) : w(o)
                }
            ...
            c = function (e, i) {
                function n(t) {
                    a.tick(t), a.updateElement(e), a.completed() ? (i.callback && i.callback(e), i.loop && i.loop > 1 && (i.loop--, a.restart(), w(n))) : w(n)
                }
                var o = g(i, F({}));
                i.movement = o;
                var a = k(i);
            ...
            g = function (e, t, i) {
                ...
                var n = "position",
                    ...
                    u = "height",
                    d = "opacity";
                return i && (n = "fromPosition", o = "fromRotation", a = "fromSkew", r = "fromRotationPost", s = "fromScale", l = "fromScalePost", c = "fromWidth", u = "fromHeight", d = "fromOpacity"), t.position = V(e[n], t.position), t.rotation = V(e[o], t.rotation), t.rotationPost = V(e[r], t.rotationPost), t.skew = V(e[a], t.skew), t.scale = V(e[s], t.scale), t.scalePost = V(e[l], t.scalePost), t.opacity = e[d], t.width = e[c], t.height = e[u], t
            },
            m = function (e, t, i) {
            ...
            b = function Y(n) {
                for (var o = e.length, a = 0; o > a; ++a) e[a](n);
                e.splice(0, o);
                ...
                return c = e.valueFeeder ? L(e.valueFeeder, t, i, s) : H(t, i, s), {
                    ...
                    tick: function (t) {
                        ...
                        if (u || (u = t), t - u > o) {
                            ...
                            r.tick(i / n), this.updateCurrentTransform(), this.completed() && !v && (e.selfFinish && e.selfFinish(), l && l(), v = !0)
                        }
                    },
                    ...
                    setValue: function (t) {
                        !p && e.startCallback && e.startCallback(), p = !0, g = Math.min(Math.max(t, 1e-4), 1 + m)
                    },
            ...
            k = function (e) {
                ...
                return {
                    ...
                    updateMovement: function () {
                        var e = i.getValue();
                        o && (u.position[0] = t.position[0] * e, u.position[1] = t.position[1] * e, u.position[2] = t.position[2] * e), a && (u.rotation[0] = t.rotation[0] * e, u.rotation[1] = t.rotation[1] * e, u.rotation[2] = t.rotation[2] * e), r && (u.rotationPost[0] = t.rotationPost[0] * e, u.rotationPost[1] = t.rotationPost[1] * e, u.rotationPost[2] = t.rotationPost[2] * e), s && (u.scale[0] = 1 + t.scale[0] * e, u.scale[1] = 1 + t.scale[1] * e), l && (u.scalePost[0] = 1 + t.scalePost[0] * e, u.scalePost[1] = 1 + t.scalePost[1] * e), c && (u.skew[0] = t.skew[0] * e, u.skew[1] = t.skew[1] * e)
                    },
                    updateElement: function (e) {
                        q(e, u.asMatrix()), J(e, u.getProperties())
                    },
                    getCurrentState: function () {
                        return u
                    },
                ...
                return {
                    ...
                    tick: function (e, l) {
                        if (0 !== e && !l && !s) {
                            var c = -(t - i) * o,
                                u = c / r;
                            n += u, t += n, n *= a, Math.abs(t - i) < .001 && Math.abs(n) < .001 && (s = !0)
                        }
                    },
            ...
            D = function (e, t) {
                e[0] = 1, e[1] = 0, e[2] = 0, e[3] = 0, e[4] = 0, e[5] = Math.cos(t), e[6] = -Math.sin(t), e[7] = 0, e[8] = 0, e[9] = Math.sin(t), e[10] = Math.cos(t),
                    e[11] = 0, e[12] = 0, e[13] = 0, e[14] = 0, e[15] = 1
            },
            T = function (e, t) {
            ...
            B = function () {
                ...
                return M(e), {
                    ...
                    translate: function (n, o, a) {
                        return z(e, t), S(i, n, o, a), N(t, i, e), this
                    },
                    rotateX: function (n) {
                        return z(e, t), D(i, n), N(t, i, e), this
                    },
                    rotateY: function (n) {
                        return z(e, t), T(i, n), N(t, i, e), this
                    },
                    rotateZ: function (n) {
                        return z(e, t), O(i, n), N(t, i, e), this
                    },
                    scale: function (n, o) {
                        return z(e, t), U(i, n, o), N(t, i, e), this
                    },
                    skew: function (n, o) {
                        return z(e, t), R(i, n, o), N(t, i, e), this
                    }
                }
            },
            N = function (e, t, i) {
                ...
                return {
                    tween: function (e) {
                        if (r) {
                            ...
                            a.position[0] = n.position[0] + e * t, a.position[1] = n.position[1] + e * i, a.position[2] = n.position[2] + e * g
                        }
                        if (s) {
                            var m = o.rotation[0] - n.rotation[0],
                                v = o.rotation[1] - n.rotation[1],
                                w = o.rotation[2] - n.rotation[2];
                            a.rotation[0] = n.rotation[0] + e * m, a.rotation[1] = n.rotation[1] + e * v, a.rotation[2] = n.rotation[2] + e * w
                        }
                        if (l) {
                            var b = o.rotationPost[0] - n.rotationPost[0],
                                y = o.rotationPost[1] - n.rotationPost[1],
                                k = o.rotationPost[2] - n.rotationPost[2];
                            a.rotationPost[0] = n.rotationPost[0] + e * b, a.rotationPost[1] = n.rotationPost[1] + e * y, a.rotationPost[2] = n.rotationPost[2] + e * k
                        }
                        if (d) {
                            var A = o.skew[0] - n.skew[0],
                                x = o.skew[1] - n.skew[1];
                            a.skew[0] = n.skew[0] + e * A, a.skew[1] = n.skew[1] + e * x
                        }
                        if (c) {
                            var C = o.scale[0] - n.scale[0],
                                P = o.scale[1] - n.scale[1];
                            a.scale[0] = n.scale[0] + e * C, a.scale[1] = n.scale[1] + e * P
                        }
                        if (u) {
                            var I = o.scalePost[0] - n.scalePost[0],
                                E = o.scalePost[1] - n.scalePost[1];
                            a.scalePost[0] = n.scalePost[0] + e * I, a.scalePost[1] = n.scalePost[1] + e * E
                        }
                        if (f) {
            ...
            L = function (e, t, i, n) {
                ...
                return {
                    tween: function (t) {
                        ...
                        void 0 !== r.width && (s.width = a.width + t * i), void 0 !== r.height && (s.height = a.height + t * n), void 0 !== r.opacity && (s.opacity = a.opacity + t * c)
                    },
                    asMatrix: function () {
                        return o
                    },
        ...
        }(jQuery), r.createMatrix = B, r.setElementTransform = q, r
    })
}, function (e, t) {
    "use strict";
    ...
    var a = function () {
        ...
        p = function () {
            function e(t, i) {
                o(this, e), t.content.data = t.content.data.reduce(function (e, t, i, n) {
            ...
            return a(e, [{
                ...
                value: function () {
                    return this.swipeImgElm = (0, s["default"])('<img src="' + window.Config.getImgOss("images/swiper/swipewarn.png") + '"></img>'), this.swipeImgElm.css({
                        position: "absolute",
    ...
    (function (t) {
        ...
        r = "function" == typeof d ? o(n) : a(n), i.requestFlush = r, i.makeRequestCallFromTimer = a
    }).call(t, function () {
        return this
    }())
}, , function (e, t, i) {
            ...
            return a(e, [{
                ...
                value: function (e) {
                    ...
                    if (g["default"].send("pageLoadStart", e.index), e.bgpic && "0" !== e.bgpic && " " !== e.bgpic) try {
                        var a = void 0,
                            r = {};
                        if (console.log("log " + e.bgpic), "texture" === e.bgpictype) a = e.bgpic;
                        else if (0 === e.bgpic.indexOf("user/")) a = window.Config.getImgUrl(e.bgpic);
                        else if (e.bgpic.indexOf("test.img.maka.im") > 0 || e.bgpic.indexOf("test.img1.maka.im") > 0) a = e.bgpic;
                        else if (e.bgpic.indexOf("img2") > 0 || e.bgpic.indexOf("img1") > 0) a = e.bgpic;
                        else if (-1 === e.bgpic.indexOf("user/") && e.bgpic.indexOf("img1.maka.im") > -1) a = e.bgpic;
                        else if (e.bgpic.indexOf("assets/") > -1) a = window.Config.getImgUrl(e.bgpic);
                        else {
                        ...
                        e.bgpicCropData && !window.Config.isGif(e.bgpic) && window.Config.isAppNormalMode() ? a = window.Config.addCrop(a, e.bgpicCropData) : window.Config.isGif(e.bgpic) || (a = b["default"].addTail(a)), r.inw = e.bgpicwidth;
                        var k = y.loadImage(a, r, e);
                        k = k.then(function (t) {
                            return e.bgDom = (0, s["default"])(t), t
                        }), n.push(k)
                    } catch (A) {
                        d["default"].log(A), d["default"].logPiwik(window.Config.getEnvironment(), window.Config.isAppNormalMode(), A)
                    }
                    if (e.content.map(function (o) {
                            switch (o.type) {
                                case "pic":
                                    ...
                                    l = l.then(function (e) {
                                        return o.inw && "auto" !== o.inw || (o.inw = e.width), o.dom = (0, s["default"])(e), e
                                    }), n.push(l);
                                    break;
                                case "pButton":
                                ...
                                case "pEraser":
                                    var r = window.Config.getImgUrl(o.picid),
                                        ...
                                        h = y.loadImage(f, o, e);
                                    h = h.then(function (e) {
                                        return o.inw && "auto" !== o.inw || (o.inw = e.width), o.imgDom = (0, s["default"])(e), e
                                    }), n.push(h);
                                    break;
                                case "comparison":
                                    if (!o.picdata) break;
                                ...
                                case "pshape":
                                    ...
                                    g = g.then(function (e) {
                                        var t = (0, s["default"])(e);
                                        return d["default"].processSVG(t), o.svgXml = t, t
                                    }), n.push(g);
                                    break;
                                ...
                                case "phone_call":
                                    ...
                                    w = w.then(function (e) {
                                        return o.bgDom = (0, s["default"])(e), e
                                    }), k = k.then(function (e) {
                                        return o.phoneInfoDom = (0, s["default"])(e), e
                                    }), A = A.then(function (e) {
                                        return o.phoneRemindDom = (0, s["default"])(e), e
                                    }), x = x.then(function (e) {
                                        return o.phonecallDom = (0, s["default"])(e), e
                                    }), n.push(w), n.push(k), n.push(A), n.push(x);
                                    break;
                                case "glass_break":
                                    var C = [1, 2, 3, 4, 5];
                                    o.imgDom = new Array(5), C.map(function (t) {
                                        var i = y.loadImage(window.Config.getGlassBreakUrl(t + ".png"), o, e);
                                        i = i.then(function (e) {
                                            return o.imgDom[t - 1] = e, e
                                        }), n.push(i)
                                    });
                                    break;
                                case "slide":
                                    ...
                                    for (var I in o.data) {
                                        var E = o.data[I],
                                            j = window.Config.getImgUrl(E.picid),
                                            S = window.Config.getImgUrl(E.picid);
                                        window.Config.isGif(j) || (S = b["default"].addTail(S, "jpg", E.inw));
                                        var D = new Image;
                                        D.src = S, E.imgDom = (0, s["default"])(D)
                                    }
                                    break;
                                case "eleform":
                                    y.loadImage(window.Config.getImgOss("images/sending.gif"), o, e), y.loadImage(window.Config.getImgOss("images/sendsucess.png"), o, e);
                                    break;
                                case "charts":
                                ...
                                case "ptext":
                                    ...
                                    //     if (!y.loadEnd[O]) {
                                    //         y.loadEnd[O] = !0;
                                    //         for (var U = [".bmp"], M = void 0, z = 0; z < U.length; z += 1) M = O + U[z], R(M)
                                    //     }
                                    //     break
                                    // }
                                    ...
                                    //             var F = B.split("url(");
                                    //             F.length;
                                    //             (0, v["default"])(B.substring(0, B.lastIndexOf("}", B.length - 2) + 1))
                                    //         } else {
                                ...
                                case "footballManager":
                                    ...
                                    if (t) {
                                        ...
                                        q = q.then(function (e) {
                                            return o.logoDom = (0, s["default"])(e), e
                                        }), n.push(q)
                                    }
                                    if (L) {
                                        var J = window.Config.getImgUrl(L),
                                            q = y.loadImage(J, o, e);
                                        q = q.then(function (e) {
                                            return o.urlDom = (0, s["default"])(e), e
                                        }), n.push(q)
                                    }
                                ...
                                case "puzzle":
                                    ...
                                    o.urls.length && (o.urlDom = [], o.urls.map(function (t) {
                                        var i = window.Config.getImgUrl(t),
                                            a = y.loadImage(i, o, e);
                                        a = a.then(function (e) {
                                            return o.urlDom.push((0, s["default"])(e)), e
                                        }), n.push(a)
                                    }));
                                    break;
                                case "vote":
                                    ...
                                    if (Q) {
                                        ...
                                        q = q.then(function (e) {
                                            return o.picDom = (0, s["default"])(e), e
                                        }), n.push(q)
                                    }
                                    break;
                                case "relay":
                                    if (!o.ownInfo) {
                                        ...
                                        q = q.then(function (e) {
                                            return e && 200 == e.code && (o.canRealy = e.data.can_relay, o.relayed = e.data.already_relay, o.rank = e.data.rank, o.ownInfo = e.data.own_info.ercode ? void 0 : e.data.own_info, o.picSrc = e.data.participators_info || []), e
                                        }), n.push(q)
                                    }
                                    break;
                                case "map":
                                    ...
                                    if (Y) {
                                        if (window.mapAllPromise) {
                                            var K = new c["default"](function (e) {
                                        ...
                                        var K = new c["default"](function (e) {
                                            ...
                                            t.type = "text/javascript", t.id = "map-script";
                                            var i = "cb_" + o.id;
                                            t.src = "http://map.qq.com/api/js?v=2.exp&callback=" + i, document.body.appendChild(t), window.mapAllPromise = [e], window[i] = function () {
                                ...
                                case "phoneSound":
                                    ...
                                    l = l.then(function (e) {
                                        return o.picDom = (0, s["default"])(e), e
                                    }), n.push(l), r = window.Config.getImgUrl(o.middle.imgSrc);
                                    var G = y.loadImage(r, o, e);
                                    G = G.then(function (e) {
                                        return o.middleDom = (0, s["default"])(e), e
                                    }), n.push(G);
                                    break;
                                case "phoneLock":
                        ...
                        x = x.then(function (e) {
                            return e && 200 == e.code ? b["default"].setVoteData(e.data) : b["default"].voteData = null, e
                        }), n.push(x)
                    }
                ...
                value: function (e, t, i) {
                    ...
                    var n = t.fontId;
                    return t.fontVersion && 10 == t.fontVersion && (n = "maka" + e.replace(/[\/:._]/g, "")), new c["default"](function (i) {
                        var o = window.URL || window.webkitURL;
                        if (!o) {
                            var a = '@font-face {font-family: "' + n + '"; src: url("' + e + '") ;font-weight: normal; font-style: normal;}';
                            return t.fontError = 0, (0, v["default"])(a), void i("fontUrl" + e)
                        }
                        ...
                        r.onload = function () {
                            if (200 == this.status) {
                                ...
                                t.fontError = 0, (0, v["default"])(l)
                            }
                        }, r.onloadend = function () {
                            clearTimeout(s), i(e + " load end")
                        }, r.onerror = function () {
                            clearTimeout(s);
                            var o = '@font-face {font-family: "' + n + '"; src: url("' + e + '") ;font-weight: normal; font-style: normal;}';
                            (0, v["default"])(o), t.fontError = 1, console.log("", e), i("fontUrl" + e)
                        }, r.send()
                    })
                }
            }, {
                ...
                value: function (e, t, i) {
                    return new c["default"](function (n) {
                        ...
                        if (o.onload = function () {
                                ...
                                d["default"].logPiwik(window.Config.getEnvironment(), window.Config.isAppNormalMode(), "Load image failed " + e + t), a || (d["default"].log("Load image failed " + e + t), a = !0, n(o))
                ...
                value: function () {
                    return new c["default"](function (e) {
                        i.e(0, function (t) {
                            window.FootballManager = i(78), e(window.FootballManager)
                        })
                    })
                }
            }, {
                ...
                value: function () {
                    return new c["default"](function (e) {
                        i.e(2, function (t) {
                            window.Puzzle = i(79), e(window.Puzzle)
                        })
                    })
                }
            }, {
                ...
                value: function () {
                    return new c["default"](function (e) {
                        i.e(1, function (t) {
                            window.LightSlider = i(83), i(81), e(window.LightSlider)
                        })
                    })
                }
            }, {
                ...
                value: function () {
                    return console.log("load chart"), new c["default"](function (e) {
                        i.e(3, function (t) {
                            console.log("chart end"), window.Highcharts = i(16), e(window.Highcharts)
                        })
                    })
                }
            }, {
    ...
    var a = function () {
        ...
        l = (n(s), function () {
            function e() {
                o(this, e), this.bgMusic = void 0, this.effectMusic = void 0, this.bgPausedByUser = !1, this.effectPlaying = !1
            }
            return a(e, [{
                key: "setBgMusic",
                value: function (e) {
                ...
                key: "playBg",
                value: function () {
                    this.effectMusic && this.effectMusic.pause(), this.bgMusic && this.bgMusic.play(), this.bgPausedByUser = !1
                }
            }, {
                key: "pauseBg",
                value: function () {
                    var e = arguments.length <= 0 || void 0 === arguments[0] ? !0 : arguments[0];
                    this.bgMusic && this.bgMusic.pause(), e && (this.bgPausedByUser = !0)
                }
            }, {
                key: "resumeBg",
                value: function () {
                ...
                key: "playEffect",
                value: function () {
                    this.bgMusic && this.bgMusic.pause(), this.effectMusic && this.effectMusic.play(), this.effectPlaying = !0
                }
            }, {
                key: "pauseEffect",
                value: function () {
                    this.effectMusic && this.effectMusic.pause(), this.bgPausedByUser || this.bgMusic && this.bgMusic.play(), this.effectPlaying = !1
                }
            }, {
                key: "isEffectPlaying",
                value: function () {
    ...
    var Ie = null,
        Ee = function () {
            function e() {
                o(this, e), window.cj = d["default"], window.ppt = this, this.currentPageIndex = 0, this.pageChangeHandlers = [], this.pageEffect = [], this.swipeDownLock = !1, this.examinationResult = null, this.hasPhoneCallEffect = !1, this.hasPhoneSoundEffect = !1, window.Config.isAppNormalMode() && (this.audioEffect = new Audio, ge["default"].setEffectMusic(this.audioEffect)), this.pageZLevel = {
                    top: 999,
                    bottom: 0,
                    music: 1e3
                }, this.lazyLoader = new p["default"], this.firstEnsurePagesStarted = !1, Ie = this, this.initSwiper(), this.ensureCanvas(), this.preload = new S["default"], this.option = {}
            }
            return a(e, [{
                key: "findFirstPageType",
                value: function () {
                    return d["default"].contentJSON[0] && d["default"].contentJSON[0].content && d["default"].contentJSON[0].content[0] && d["default"].contentJSON[0].content[0].type
                }
            }, {
                key: "findPageEffect",
                value: function () {
                    var e = !1,
                        t = !1;
                    for (var i in d["default"].contentJSON) {
                        var n = d["default"].contentJSON[i].content;
                        for (var o in n) "phone_call" === n[o].type ? e = !0 : "phoneSound" === n[o].type && (t = !0)
                    }
                    return {
                        hasPhoneCallEffect: e,
                        hasPhoneSoundEffect: t
                    }
                }
            }, {
                key: "setOption",
                ...
                value: function () {
                    ...
                    var n = (0, s["default"])(".ADpage");
                    (0, s["default"])(window).on("message", function (t) {
                ...
                value: function () {
                    ...
                    Ie.scaleRatio = l > r ? r : l, Ie.bgScaleRatio = r > l ? r : l, l > r ? (e = o > document.body.clientWidth ? document.body.clientWidth : o, t = e * (a / o), i = o < document.body.clientWidth ? (document.body.clientWidth - o) / 2 : 0, n = t < document.body.clientHeight ? (document.body.clientHeight - t) / 2 : 0) : (t = a > document.body.clientHeight ? document.body.clientHeight : a, e = t * (o / a), n = a < document.body.clientHeight ? (document.body.clientHeight - a) / 2 : 0, i = e < document.body.clientWidth ? (document.body.clientWidth - e) / 2 : 0), v["default"].log("Ensuring canvas..."), (0, s["default"])(".maka-canvas").css({
                        width: "100%",
                        height: "100%",
                        left: "0px",
                        top: "0px",
                ...
                value: function (e) {
                    if ("string" == typeof e && -1 !== e.indexOf("px")) {
                        ...
                        return parseInt(Math.round(t * Ie.scaleRatio)) + "px"
                    }
                    return e = parseInt(Math.round(e * Ie.scaleRatio)), e + "px"
                }
            }, {
                key: "setCommonCSS",
                value: function (e, t) {
                ...
                value: function () {
                    if (this.preload.hide(), this.currentPageIndex = 0, window.Config.isAppNormalMode()) {
                        ...
                        Ie.showPageInAnimation(e), Ie.showBackgroundMusic()
                    }
                    window.projectVersion && 0 != window.projectVersion.viplevel && Ie.showBottomMenu(), Ie.onPageChange(0), (0, s["default"])(".maka-page-0").show(), (0, s["default"])(".maka-pages").show(), M["default"].send("pageVisit", Ie.currentPageIndex), Ie.showAdarea(), Ie.showArrow(), Ie.option.pageChangeCallback && Ie.option.pageChangeCallback();
                    var t = d["default"].getBottomMenu(),
                        i = [];
                    if (t && t.menuOpen) {
                        var n = t.bottomMenu;
                        n.forEach(function (e) {
                            "link" === e.type && 1 !== e.link && i.push(e.link)
                        })
                    }
                    Ie.ensurePages([1].concat(i))
                }
            }, {
                key: "postPageLength",
                value: function () {
                    this.postMsg({
                        type: "pan_pageLength",
                        pageLength: d["default"].getPageLength()
                    })
                }
            }, {
                ...
                value: function () {
                    if (window.Config.isAppNormalMode()) {
                        var e = d["default"].getMusic(),
                            t = Ie.findFirstPageType(),
                            i = Ie.findPageEffect();
                        if (Ie.hasPhoneCallEffect = i.hasPhoneCallEffect, Ie.hasPhoneSoundEffect = i.hasPhoneSoundEffect, e) {
                            var n = (0, s["default"])("<audio loop src = " + window.Config.getMusicUrl(e) + ' id="bgmedia" autoplay preload></audio>');
                            (0, s["default"])(".maka-canvas").append(n), Ie.audioBackground = n[0], Ie.audioBackground.play(), ge["default"].setBgMusic(Ie.audioBackground)
                        }
                        window.wx && window.wx.ready(function () {
                            if (Ie.initEffectMusic(), "phone_call" === t) Ie.audioEffect.src = "http://res2.maka.im/cdn/maka/release/music/phonecall_music2.mp3", Ie.audioEffect.loop = !0, ge["default"].playEffect();
                            else if ("phoneSound" === t) {
                                var e = d["default"].contentJSON[0].content[0].sound;
                                Ie.audioEffect.src = window.Config.getMusicUrl({
                                    id: e,
                                    version: 1
                                }), Ie.audioEffect.loop = !1, ge["default"].playEffect()
                            } else ge["default"].playBg()
                        }, !1);
                        var o = function a() {
                            setTimeout(function () {
                                // return ge["default"].isEffectPlaying() ? void ge["default"].playEffect() : (Ie.toggleBackgroundMusic(!0), Ie.audioBackground.paused || (0, s["default"])("body").off("touchstart touchmove touchend", a), void v["default"].log("Start play music for user......."))
                            })
                        };
                        (0, s["default"])("body").on("touchstart touchmove touchend", o)
                    }
                }
            }, {
                key: "initEffectMusic",
                value: function () {
                    if (Ie.hasPhoneCallEffect) Ie.audioEffect.src = "http://res2.maka.im/cdn/maka/release/music/phonecall_music2.mp3", Ie.audioEffect.loop = !0, ge["default"].playEffect(), ge["default"].pauseEffect();
                    else if (Ie.hasPhoneSoundEffect) {
                        var e = d["default"].contentJSON[0].content[0].sound;
                        Ie.audioEffect.src = window.Config.getMusicUrl({
                            id: e,
                            version: 1
                        }), Ie.audioEffect.loop = !1, ge["default"].playEffect(), ge["default"].pauseEffect()
                    }
                }
            }, {
                ...
                value: function () {
                    ...
                    if (e && (Ie.musicDom = (0, s["default"])("<img/>"), Ie.musicDom.css({
                            width: Ie.scale(60),
                            height: Ie.scale(60),
                            right: Ie.scale(30),
                            top: Ie.scale(30),
                            ...
                            position: "absolute",
                            display: "block",
                            "z-index": Ie.pageZLevel.music
                        }), Ie.isMusicOn = !0, Ie.musicDom.attr({
                            src: x["default"]
                        }), (0, s["default"])(".maka-pages").append(Ie.musicDom), window.Config.isAppNormalMode())) {
                ...
                value: function () {
                    ...
                    if (e && e.menuOpen) {
                        var t = e.bottomMenuColor,
                            i = e.bottomMenu;
                        Ie.menuDom = (0, s["default"])("<div></div>"), Ie.menuDom.css({
                            width: "100%",
                            height: Ie.scale(90),
                            left: 0,
                            bottom: 0,
                        ...
                        var n = "ontouchend" in document ? "touchstart" : "click",
                            o = function (e) {
                                ...
                                "url" === t.type ? (o = (0, s["default"])("\n          <div>\n            <span>" + t.name + "<span>\n          </div>"), o.on(n, function () {
                                    var e = void 0;
                                    e = t.url.indexOf("http://") >= 0 || t.url.indexOf("https://") >= 0 ? t.url : "http://" + t.url, window.location.href = e
                                })) : (o = (0, s["default"])("\n          <div>\n            <span>" + t.name + "</span>\n          </div>"), o.on(n, function () {
                                    Ie.showPage(t.link)
                                })), o.css({
                                    flex: 1,
                        ...
                        for (var a in i) o(a);
                        (0, s["default"])(".maka-pages").append(Ie.menuDom)
                    }
                }
            }, {
                key: "toggleBackgroundMusic",
                value: function (e) {
                    window.Config.isAppNormalMode() && (e === !0 ? Ie.isMusicOn = e : Ie.isMusicOn = !Ie.isMusicOn, Ie.musicDom && (Ie.isMusicOn ? (Ie.musicDom.attr({
                        src: x["default"]
                    }), ge["default"].playBg()) : (Ie.musicDom.attr({
                        src: k["default"]
                    }), ge["default"].pauseBg(), M["default"].send("closeMusic")), Ie.audioBackground.paused && (Ie.isMusicOn = !1, Ie.musicDom && Ie.musicDom.attr({
                        src: k["default"]
                    }))))
                }
            }, {
                ...
                value: function (e, t) {
                    if (e && 0 !== e.length) {
                        ...
                        var i = [],
                            n = [];
                        Ie.firstEnsurePagesStarted || (Ie.preload.increaseSteps(1), v["default"].runAsync(function () {
                            Ie.preload.increaseProgress()
                        })), e.forEach(function (e) {
                            if (d["default"].hasPage(e)) {
                                var t = d["default"].getPage(e);
                                t.index = e;
                                var n = Ie.lazyLoader.preparePage(t);
                                if (void 0 !== n.length) {
                                    if (!Ie.firstEnsurePagesStarted) {
                                        Ie.preload.increaseSteps(n.length);
                            ...
                            var t = new c["default"](function (t) {
                                c["default"].all(e.promiseArray).then(function () {
                                    Ie.renderPage(e.page), t(e.page)
                                })
                            });
                            Ie.firstEnsurePagesStarted || (Ie.preload.increaseSteps(1), t = t.then(function () {
                                Ie.preload.increaseProgress(1)
                            })), n.push(t)
                        }), c["default"].all(n).then(function () {
                            t()
                        })["catch"](v["default"].log), Ie.firstEnsurePagesStarted = !0
                    }
                }
            }, {
                key: "ensureAllPages",
                ...
                value: function () {
                    var e = d["default"].getPage(Ie.currentPageIndex);
                    if (!xe["default"].isNeedStopAni(e.effect) || !window.pageEffectRuning) {
                        if (v["default"].log("Decide to show previous page, currentPageIndex:" + Ie.currentPageIndex), Ie.currentPageIndex > 0) {
                            var t, i, n, o, a, r, l, c = function () {
                                M["default"].send("pageVisit", Ie.currentPageIndex - 1), M["default"].send("pageLeave", Ie.currentPageIndex), t = "maka-page-" + Ie.currentPageIndex, i = (0, s["default"])("." + t), n = Ie.currentPageIndex - 1;
                                var e = Ie.currentPageIndex;
                                if (o = "maka-page-" + n, a = (0, s["default"])("." + o), r = (0, s["default"])(".maka-page-" + (Ie.currentPageIndex + 1)), r && r.length > 0 && r.css({
                                        display: "none"
                                    }), window.Config.isAppNormalMode()) {
                                    var c = d["default"].getPage(Ie.currentPageIndex);
                                    if (c.swipeDownLock) return {
                                        v: void 0
                                    };
                                    Ie.panDownAnimations || c.swipeDownLock || Ie.initpanDownAnimations(c), a.show(), Ie.animateToPrevPage(function () {
                                        var t = d["default"].getPage(e),
                                            o = d["default"].getPage(n);
                                        i.hide(), a.show(), Ie.hidePageElement(t), Ie.showPageInAnimation(o), Ie.showAdarea(), Ie.showArrow(), setTimeout(function () {
                                            Ie.ensurePages([n, n - 1, n - 2])
                                        }, 20)
                                    })
                                } else i.hide(), a.show(), l = d["default"].getPage(n), Ie.showPageInAnimation(l);
                                Ie.onPageChange(n, e), Ie.currentPageIndex = n, Ie.option.pageChangeCallback && Ie.option.pageChangeCallback()
                            }();
                            if ("object" == typeof c) return c.v
                        }
                        Ie.showAdarea(), Ie.showArrow()
                    }
                }
            }, {
                key: "showPage",
                value: function (e) {
                    e === Ie.currentPageIndex || e >= d["default"].getPageLength() || Ie.ensurePages([e], function () {
                        var t = e,
                            i = d["default"].getPageLength(),
                            n = Ie.currentPageIndex,
                            o = (n + 1) % i,
                            a = (0, s["default"])(".maka-page-" + t),
                            r = (0, s["default"])(".maka-page-" + n),
                            l = (0, s["default"])(".maka-page-" + o);
                        xe["default"].clearAnimation(a), a.hide(), r.hide(), a.css({
                            opacity: 1
                        }), l.hide(), a.fadeIn(function () {
                            var i = d["default"].getPage(t);
                            Ie.showPageInAnimation(i);
                            var o = d["default"].getPage(n);
                            Ie.hidePageElement(o), Ie.currentPageIndex = e, Ie.option.pageChangeCallback && Ie.option.pageChangeCallback(), Ie.showAdarea(), Ie.showArrow(), setTimeout(function () {
                                Ie.ensurePages([e - 2, e - 1, e + 1, e + 2])
                            }, 20)
                        }), Ie.panUpAnimations = null, Ie.panDownAnimations = null
                    })
                }
            }, {
                key: "showNextPage",
                value: function (e) {
                    var t = d["default"].getPage(Ie.currentPageIndex);
                    xe["default"].isNeedStopAni(t.effect) && window.pageEffectRuning || (v["default"].log("Decide to show next page, currentPageIndex:" + Ie.currentPageIndex), Ie.hasNextPage() ? ! function () {
                        var t = d["default"].getPageLength(),
                            i = Ie.currentPageIndex,
                            n = (i + 1) % t;
                        Ie.ensurePages([n], function () {
                            M["default"].send("pageVisit", n), M["default"].send("pageLeave", i);
                            var t = (0, s["default"])(".maka-page-" + n),
                                o = (0, s["default"])(".maka-page-" + i);
                            if (window.Config.isAppNormalMode()) {
                                var a = d["default"].getPage(i);
                                if (a.swipeUpLock) return;
                                Ie.panUpAnimations || a.swipeUpLock || Ie.initpanUpAnimations(a), t.show(), Ie.animateToNextPage(function () {
                                    var e = d["default"].getPage(i),
                                        a = d["default"].getPage(n);
                                    o.hide(), t.show(), Ie.hidePageElement(e), Ie.showPageInAnimation(a), Ie.showAdarea(), Ie.showArrow(), setTimeout(function () {
                                        Ie.ensurePages([n + 1, n + 2, n + 3])
                                    }, 20), Ie.panUpAnimations = null
                                })
                            } else {
                                o.hide(), t.show();
                                var r = d["default"].getPage(Ie.currentPageIndex);
                                Ie.showPageInAnimation(r), Ie.ensurePages([n + 1, n + 2, n + 3])
                            }
                            Ie.onPageChange(n, i), Ie.currentPageIndex = n, Ie.showAdarea(), Ie.showArrow(), Ie.option.pageChangeCallback && Ie.option.pageChangeCallback(), e && e()
                        })
                    }() : null);
                }
            }, {
                ...
                value: function (e) {
                    ...
                    Ie.pageChangeHandlers.map(function (i) {
                        i(e, t)
                    })
                }
            }, {
                key: "hasNextPage",
                value: function () {
                    return Ie.currentPageIndex < d["default"].getPageLength() - 1
                }
            }, {
                key: "getCurrentPageIndex",
                value: function () {
                    return Ie.currentPageIndex
                }
            }, {
                key: "showAdarea",
                value: function () {
                    if (window.Config.isAppNormalMode()) {
                        var e = (0, s["default"])(".maka-adArea"),
                            t = 100;
                        Ie.currentPageIndex === d["default"].getPageLength() - 1 ? (e.fadeIn(), v["default"].log("show"), "free_user" === window.projectVersion.viplevel && v["default"].parentPost({
                            type: "showAD"
                        }), (0, s["default"])(".maka-adArea").unbind(), (0, s["default"])(".maka-adArea").on("click", function () {
                            M["default"].send("makaAD", t)
                ...
                value: function (e) {
                    window.Config.isAppNormalMode() && e.content.forEach(function (e) {
                        "video" === e.type ? e.ele.removeSrc() : "charts" === e.type ? e.dom.hide() : Pe["default"].stopAnimation(e)
                    })
                }
            }, {
                ...
                value: function (e) {
                    window.Config.isAppNormalMode() && e.content.forEach(function (e) {
                        Pe["default"].actAnimation(e), e.showCallback && e.showCallback(), "charts" === e.type && (e.chartElement.render(), e.dom.fadeIn()), "video" === e.type && e.ele.setSrc()
                    })
                }
            }, {
                key: "animateToNextPage",
                value: function (e) {
                    var t = Ie.panUpAnimations ? Ie.panUpAnimations.length : 1,
                        i = xe["default"].debouncedCallback(e, t);
                    Ie.preUp || (Ie.preUp = {});
                    var n = function (e) {
                        var t = Ie.currentPageIndex;
                        Ie.preUp[t + "" + e] = Ie.panUpAnimations[e], Ie.panUpAnimations[e].finish(function () {
                            delete Ie.preUp[t + "" + e], i()
                        })
                    };
                    for (var o in Ie.panUpAnimations) n(o);
                    Ie.panUpAnimations = null, Ie.panDownAnimations = null
                }
            }, {
                key: "animateToPrevPage",
                value: function (e) {
                    var t = Ie.panDownAnimations ? Ie.panDownAnimations.length : 1,
                        i = xe["default"].debouncedCallback(e, t);
                    Ie.preDown || (Ie.preDown = {});
                    var n = function (e) {
                        var t = Ie.currentPageIndex;
                        Ie.preDown[t + "" + e] = Ie.panDownAnimations[e], Ie.panDownAnimations[e].finish(function () {
                            delete Ie.preDown[t + "" + e], i()
                        })
                    };
                    for (var o in Ie.panDownAnimations) n(o);
                    Ie.panUpAnimations = null, Ie.panDownAnimations = null
                }
            }, {
                key: "onSwipeDown",
                ...
                value: function (e) {
                    var t = (0, s["default"])(".maka-page-" + (Ie.currentPageIndex + 1) % d["default"].getPageLength()),
                        i = (0, s["default"])(".maka-page-" + Ie.currentPageIndex);
                    Ie.panUpAnimations = [], Ie.panUpAnimations.push(xe["default"].getLeaveEffect(e.effect, i)), Ie.panUpAnimations.push(xe["default"].getEntryEffect(e.effect, t))
                }
            }, {
                key: "initpanDownAnimations",
                value: function (e) {
                    e = d["default"].getPage(e.index - 1);
                    var t = (0, s["default"])(".maka-page-" + Ie.currentPageIndex),
                        i = (0, s["default"])(".maka-page-" + (Ie.currentPageIndex - 1));
                    Ie.panDownAnimations = [], Ie.panDownAnimations.push(xe["default"].getBackEffect(e.effect, i)), Ie.panDownAnimations.push(xe["default"].getOutEffect(e.effect, t))
                }
            }, {
                key: "onPan",
                value: function (e) {
                    var t = d["default"].getPage(Ie.currentPageIndex);
                    if (!xe["default"].isNeedStopAni(t.effect) || !window.pageEffectRuning) {
                        var i = document.body.clientHeight,
                            n = e.deltaY / i,
                            o = (0, s["default"])(".maka-page-" + (Ie.currentPageIndex + 1));
                        if (!(0 == o.length && Ie.currentPageIndex < d["default"].getPageLength() - 1)) {
                            var a = (0, s["default"])(".maka-page-" + (Ie.currentPageIndex - 1));
                            e.deltaY < 0 && !Ie.panUpAnimations && Ie.hasNextPage() && !e.isFinal && !t.swipeUpLock && Ie.initpanUpAnimations(t), e.deltaY > 0 && !Ie.panDownAnimations && Ie.currentPageIndex > 0 && !e.isFinal && !t.swipeDownLock && Ie.initpanDownAnimations(t), n > 1 ? n = 1 : -1 > n && (n = -1);
                            ...
                            if ((r || l) && (console.log(e.changedPointers[0].clientX + "x" + document.body.clientWidth + "y" + e.changedPointers[0].clientY), this.hammerPages.stop(), e.isFinal = !0), e.isFinal)
                                if (0 > n)
                                    if (Math.abs(e.deltaY) > Math.abs(e.deltaX)) console.log("showNextPage", window.top), Ie.postMsg({
                                        type: "pan_nextPage"
                                    }), Ie.showNextPage();
                                    else {
                                        for (var c in Ie.panUpAnimations) Ie.panUpAnimations[c].rollback();
                                        Ie.panUpAnimations = null
                                    }
                            else if (Math.abs(e.deltaY) > Math.abs(e.deltaX)) console.log("showPreviousPage", window.top), Ie.postMsg({
                                type: "pan_prevPage"
                            }), Ie.showPreviousPage();
                            else {
                                for (var c in Ie.panDownAnimations) Ie.panDownAnimations[c].rollback();
                                Ie.panDownAnimations = null
                            } else if (0 > n && -.1 > n && !t.swipeUpLock) Ie.ensurePages([Ie.currentPageIndex + 1], function () {
                                o.show();
                                for (var e in Ie.panUpAnimations) Ie.panUpAnimations[e].setValue(-n);
                                for (var e in Ie.panDownAnimations) Ie.panDownAnimations[e].setValue(0)
                            });
                            else if (n > 0 && n > .1 && !t.swipeDownLock) {
                                a.show();
                                for (var c in Ie.panDownAnimations) Ie.panDownAnimations[c].setValue(n);
                                for (var c in Ie.panUpAnimations) Ie.panUpAnimations[c].setValue(0)
                            }
                        }
                    }
                }
                ...
                value: function (e) {
                    ...
                    t.css({
                        width: Ie.scale(e.w),
                        height: Ie.scale(e.h),
                        left: Ie.scale(e.left),
                        top: Ie.scale(e.top),
                        position: "absolute",
                        opacity: e.opacity,
                        transform: Ie.rotate(e.rotate),
                        cursor: "pointer"
                    }), e.hasUrl && e.imgUrl && t.on("click", function () {
                        var t = void 0;
                        t = e.imgUrl.indexOf("http") >= 0 ? e.imgUrl : "http://" + e.imgUrl, window.open(t)
                    });
                    var n = window.Config.isAppNormalMode() ? "100% 100%" : "contain",
                        o = void 0,
                        a = void 0,
                        r = void 0;
                    e.cropData && !window.Config.isGif(e.picid) && window.Config.isAppNormalMode() ? (r = n, o = 0, a = 0) : (r = "auto" === e.inw || 0 === e.inw ? n : Ie.scale(e.inw), o = Ie.scale(e.intop), a = Ie.scale(e.inleft)), i.css({
                        position: "absolute",
                        width: "100%",
                        height: "100%",
                        overflow: "hidden",
                        borderRadius: Ie.scale(e.borderradius * e.h / 200),
                        boxShadow: Ie.shadow(e.boxshadow),
                ...
                value: function (e) {
                    ...
                    e.version >= 21 && n.addClass("no_margin");
                    var o = {
                            position: "absolute",
                            width: e.w ? Ie.scale(e.w) : "auto",
                            height: e.h && e.version >= 1 ? Ie.scale(e.h) : "auto",
                            top: Ie.scale(e.top),
                            left: Ie.scale(e.left),
                            transform: Ie.rotate(e.rotate),
                        ...
                        a = {
                            ...
                            borderWidth: Ie.scale(e["border-width"]),
                            fontStyle: e.fontitalic ? "italic" : "normal",
                            borderRadius: Ie.scale(e.borderradius * e.height / 200),
                            boxShadow: Ie.shadow(e.boxshadow),
                            wordWrap: "break-word",
                            whiteSpace: "pre-wrap",
                    ...
                    if (b["default"].isApple()) {
                        var r = window.screen.width,
                            l = r > 375,
                            c = 0;
                        if ("auto" !== o.width) {
                            var u = l ? 2 : 1;
                            o.width = parseInt(o.width) + u + "px"
                        }
                        if (e.fontbold) {
                            var d = e.ftsize;
                            c -= 40 > d ? 1 : 40 != d || l ? 2 : 1
                        ...
                        a["letter-spacing"] = c
                    } else a["letter-spacing"] = "0"; 
                    if (i.css(o), n.css(a), e.fontId && (window.Config.isAppNormalMode() || !e.fontError && -1 == t.indexOf(e.fontTag)) && n.css({
                            "font-family": e.fontId
                        }), e.fontUrl && e.fontVersion && 10 == e.fontVersion && n.css({
                            "font-family": "maka" + e.fontUrl.replace(/[\/:._]/g, "")
                        }), n.append(e.con.replace(/<script.*?>.*?<\/script>/gi, "")), i.append(n), "text" === e.type) {
                        var f = n.get(0).firstChild;
                        for (v["default"].log(f.toString()); f.hasChildNodes();) parseInt(f.style.fontSize) && (f.style.fontSize = Ie.scale(parseInt(f.style.fontSize))), f = f.firstChild
                    }
                    return i
                }
            }, {
                key: "renderShape",
                value: function (e) {
                    var t = new Q["default"](e, this.scale);
                    return t.getElement()
                }
            }, {
                key: "renderButton",
                value: function (e) {
                    ...
                    return o && o.hasChildNodes() && (parseInt(o.style.fontSize) && (o.style.fontSize = Ie.scale(parseInt(o.style.fontSize))), o = o.firstChild), e.url ? (n.attr({
                        href: Ie.url(e.url)
                    }), n.css({
                        position: "absolute",
                        width: "100%",
                ...
                value: function (e) {
                    var t = new R["default"](e, Ie.scale);
                    return t.getElement()
                }
            }, {
                key: "renderPhoneCallButton",
                value: function (e) {
                    var t = new L["default"](e, Ie.scale);
                    return t.getDom()
                }
            }, {
                key: "renderFormList",
                value: function (e) {
                    ...
                    return t.css({
                        ...
                        o.css({
                            ...
                            height: Ie.scale(80),
                            marginBottom: Ie.scale(20),
                            fontSize: Ie.scale(30),
                            color: e.ftColor
                        }), o.attr({
                            type: "text",
                            "class": "form-input",
                        ...
                        height: Ie.scale(80),
                        fontSize: Ie.scale(30),
                        marginTop: Ie.scale(20),
                        lineHeight: Ie.scale(80),
                            ...
                            if (n[f]) {
                                ...
                                if ("" === h) {
                                    if (p.requiredFlag || void 0 === p.requiredFlag && 2 > f) {
                                        c = !1, r.html(window.Config.language.pleaseInput + p.name), o.append(r), n[f].css("border", "2px solid red");
                                        break
                                    }
                                } else {
                                    if (u = !1, 1 == p.type) {
                                    ...
                                    if (!c) {
                                        r.html(p.name + window.Config.language.wrongFormat), o.append(r), n[f].css("border", "2px solid red");
                                        break
                                    }
                                }
                        ...
                        if (u && c && (c = !1, r.html(window.Config.language.emptyForm), o.append(r)), c) {
                            ...
                            o.append(a), o.append(r), s["default"].ajax({
                                type: "post",
                                ...
                                success: function () {
                                    i.text(window.Config.language.submited), i.css({
                                        ...
                                        r.html(window.Config.language.submitSuccess + "<br>" + e.sucmsg), a.attr("src", window.Config.getImgOss("images/sendsucess.png")), o.css({
                                            background: "rgba(0,0,0,0.8)"
                                        }), o.show()
                                    }, 200)
                                },
                                error: function () {
                                    r.html(window.Config.language.submitFail), o.append(r), setTimeout(function () {
                                        o.remove()
                                    }, 2e3)
                                }
                            })
                        ...
                        (0, s["default"])(".maka-canvas").append(o), Ie.hideArrow(), o.on("mousedown touchstart", function (e) {
                            e.preventDefault(), o.unbind(), Ie.showArrow(), o.remove()
                        })
                    }), t
                }
            }, {
                ...
                value: function (e) {
                    ...
                    return a.on("panstart", function () {
                        ...
                        t + i.deltaX < e.width * Ie.scaleRatio && t + i.deltaX > 0 && o.css({
                            width: Ie.addpx(t + i.deltaX)
                        })
                    }), i
                }
            }, {
                ...
                value: function (e, t) {
                    ...
                    i.css({
                        ...
                        position: "absolute",
                        width: Ie.scale(e.inw),
                        top: Ie.scale(e.intop),
                        left: Ie.scale(e.inleft),
                        userSelect: "none",
                        "-webkit-touch-callout": "none"
                    ...
                    var o, a = !1,
                        ...
                        c = function () {
                            e.unlocking = !0, r = 0;
                            var n = (0, s["default"])("<div>è§£é”æˆåŠŸ</div>");
                            i.append(n), n.css({
                                ...
                                n.fadeOut(1e3), a ? (Ie.postMsg({
                                    type: "pan_nextPage"
                                }), Ie.showNextPage(), e.unlocking = !1) : (a = !0, t.swipeUpLock = !1, e.unlocking = !1, Ie.postMsg({
                                    type: "pan_nextPage"
                                }), Ie.showNextPage())
                            }, 1500)
                        };
                    if ("VUT6I6NZ6H2BPG1G3I54" === e.picid) l.on("touchstart mousedown", function () {
                        ...
                        u.css({
                            ...
                            o || e.unlocking || (u.show(), u.css({
                                ...
                                r += 10, r > 1500 && (clearInterval(o), c(), u.hide(), u.css({
                                    animation: "none"
                                }))
                            }, 10))
                        }), l.on("touchend mouseup", function () {
                ...
                value: function (e, t) {
                    ...
                    var i = function (i, n) {
                        if (window.Config.isAppNormalMode()) {
                            var o = t.index,
                                a = e;
                            i !== o || a.hasClick ? n == o && ge["default"].pauseEffect() : (Ie.audioEffect.src = "http://res2.maka.im/cdn/maka/release/music/phonecall_music2.mp3", Ie.audioEffect.loop = !0, ge["default"].playEffect())
                        }
                    };
                    window.Config.isAppNormalMode() && Ie.pageChangeHandlers.push(i);
                    ...
                    if (n.css({
                        ...
                        l.on("tap", function () {
                            v["default"].log("click phone call"), e.hasClick = !0, t.swipeUpLock = !1, Ie.postMsg({
                                type: "pan_nextPage"
                            }), Ie.showNextPage()
                        })
                    }
                ...
                value: function (e, t) {
                    t.swipeUpLock = !0;
                    var i = function (i) {
                        var n = (0, s["default"])("<div>ç”¨åŠ›ç ¸æˆ‘</div>"),
                            a = e,
                            r = t.index;
                        n.css({
                            position: "absolute",
                    ...
                    if (o.css({
                        ...
                        r.on("tap", function () {
                            5 > a && (Ie.audioEffect.src = window.Config.glassBreakVoice, Ie.audioEffect.loop = !1, Ie.audioEffect.play()), (0, s["default"])(o).children(".glass" + a).css({
                                opacity: 1
                            }), ++a > 4 && (e.hasBreak = !0, window.setTimeout(function () {
                                t.swipeUpLock = !1, Ie.postMsg({
                                    type: "pan_nextPage"
                                }), Ie.showNextPage()
                            }, 350))
                        })
                ...
                value: function (e) {
                    ...
                    return o.css({
                        position: "absolute",
                        width: e.width ? Ie.scale(e.width) : Ie.scale(e.w),
                        height: e.height ? Ie.scale(e.height) : Ie.scale(e.h),
                        left: Ie.scale(e.left),
                        top: Ie.scale(e.top),
                        overflow: "hidden"
                        ...
                        (0, s["default"])(o.imgDom).css({
                            position: "absolute",
                            width: Ie.scale(o.inw),
                            height: Ie.scale(o.inh),
                            left: Ie.scale(o.inleft),
                            top: Ie.scale(o.intop)
                        }), t.css({
                            position: "relative",
                            width: e.width ? Ie.scale(e.width) : Ie.scale(e.w),
                            height: e.height ? Ie.scale(e.height) : Ie.scale(e.h),
                            ...
                            position: "absolute",
                            overflow: "hidden",
                            width: Ie.scale(e.picWidth),
                            height: Ie.scale(e.picHeight)
                        }), r.append(o.imgDom), t.append(r), o.titleText && (i = (0, s["default"])("<div></div>"), i.css({
                            position: "absolute",
                            width: Ie.scale(o.titleText.width),
                            left: Ie.scale(o.titleText.left),
                            top: Ie.scale(o.titleText.top),
                            fontSize: Ie.scale(o.titleText.fontsize),
                            lineHeight: o.titleText.lineheight,
                            color: o.titleText.fontcolor
                        }), i.append(o.titleText.con), t.append(i)), o.contentText && (n = (0, s["default"])("<div></div>"), o.contentText.opacity ? n.css({
                            position: "absolute",
                            width: "100%",
                            top: Ie.scale(o.contentText.top),
                            fontSize: Ie.scale(o.contentText.fontsize),
                            ...
                            position: "absolute",
                            width: Ie.scale(o.contentText.width),
                            left: Ie.scale(o.contentText.left),
                            top: Ie.scale(o.contentText.top),
                            fontSize: Ie.scale(o.contentText.fontsize),
                            lineHeight: o.contentText.lineheight,
                            color: o.contentText.fontcolor
                        }), n.append(o.contentText.con), t.append(n)), a.append(t)
                    }), e.slider = Ie.slide, o
                }
            }, {
                key: "renderChart",
                value: function (e) {
                    var t = void 0;
                    return t = "pie" !== e.content.type ? new P["default"](e, Ie.scale) : new E["default"](e, Ie.scale),
                        e.chartElement = t, e.chartElement.render(), t.getElement()
                }
            }, {
                key: "renderEraser",
                value: function (e, t) {
                    var i = new T["default"](e, Ie, t);
                    return i.getDom()
                }
            }, {
                key: "renderCountDown",
                value: function (e, t) {
                    var i = new B["default"](e, Ie.scale);
                    return i.getDom()
                }
            }, {
                key: "renderLinkButton",
                value: function (e, t) {
                    var i = new q["default"](e, Ie.scale);
                    return i.getDom()
                }
            }, {
                ...
                value: function (e, t) {
                    t.swipeUpLock = !0;
                    var i = new G["default"](e, Ie.scale, Ie, t);
                    return i.getDom()
                }
            }, {
                key: "renderAnswer",
                value: function (e, t) {
                    var i = new X["default"](e, Ie.scale, Ie, d["default"].contentJSON);
                    return i.getDom()
                }
            }, {
                ...
                value: function (e, t) {
                    t.swipeUpLock = !0;
                    var i = new $["default"](e, t, Ie.scale, Ie);
                    return i.getDom()
                }
            }, {
                key: "renderExamChoice",
                value: function (e, t) {
                    var i = new te["default"](e, Ie.scale, Ie);
                    return i.getDom()
                }
            }, {
                key: "renderPuzzle",
                ...
                key: "renderVote",
                value: function (e, t, i) {
                    var n = new ne["default"](e, i);
                    return n.getDom()
                }
            }, {
                key: "renderRelay",
                value: function (e, t, i) {
                    var n = new ae["default"](e, i);
                    return n.getDom()
                }
            }, {
                key: "renderNewForm",
                value: function (e, t, i) {
                    var n = new se["default"](e, i);
                    return n.getDom()
                }
            }, {
                key: "renderMap",
                value: function (e, t, i) {
                    var n = new ce["default"](e, i);
                    return n.getDom()
                }
            }, {
                key: "renderVideo",
                value: function (e, t, i) {
                    var n = new Y["default"](e, i);
                    if (e.ele = n, window.Config.isAppNormalMode()) {
                        var o, a = !1,
                            r = function (e, i) {
                                var n = t.index;
                                e == n ? o = setTimeout(function () {
                                    a || e != n || (ge["default"].pauseBg(!1), a = !0)
                                }, 5e3) : (a && (ge["default"].resumeBg(), a = !1), o && (clearTimeout(o), o = void 0))
                            };
                        Ie.pageChangeHandlers.push(r)
                    }
                    return n.getDom()
                }
            }, {
                ...
                value: function (e, t, i) {
                    var n = new de["default"](e, i, Ie.bgScaleRatio),
                        o = function () {
                            v["default"].log("click phone hangup"), t.swipeUpLock = !1, Ie.postMsg({
                                type: "pan_nextPage"
                            }), Ie.showNextPage()
                        };
                    if (window.Config.isAppNormalMode()) {
                        ...
                        var a = function (i, a) {
                            var r = t.index;
                            i !== r || e.hasStart ? a == r && (n.stop(), ge["default"].pauseEffect(), Ie.audioEffect.onended = void 0) : (e.hasStart = !0, n.start(), Ie.audioEffect.src = window.Config.getMusicUrl({
                                id: e.sound,
                                version: 1
                            }), Ie.audioEffect.loop = !1, ge["default"].playEffect(), Ie.audioEffect.onended = function (e) {
                                o()
                            })
                        };
                        Ie.pageChangeHandlers.push(a);
                ...
                key: "renderPhoneLock",
                value: function (e, t, i) {
                    var n = new pe["default"](e, i, Ie.bgScaleRatio);
                    if (window.Config.isAppNormalMode()) {
                        t.swipeUpLock = !0;
                        var o = "ontouchstart" in window ? "touchstart" : "mousedown";
                        n.getEventAreaDom().on(o, function () {
                            n.animateToNext(function () {
                                v["default"].log("click phone Lock"), t.swipeUpLock = !1, Ie.postMsg({
                                    type: "pan_nextPage"
                                }), Ie.showNextPage()
                            })
                        })
                ...
                key: "renderNewSlide",
                value: function (e, t, i) {
                    var n = new ve["default"](e, i, t);
                    return window.Config.isAppNormalMode() && Ie.pageChangeHandlers.push(n.slideCyclicCall.bind(n)), n.getDom()
                }
            }, {
                key: "renderLotteryTiger",
                value: function (e, t, i) {
                    var n = new be["default"](e, i, t);
                    return n.getDom()
                }
            }, {
                key: "renderLotteryScratch",
                value: function (e, t, i) {
                    var n = new ke["default"](e, i, t);
                    return n.getDom()
                }
            }, {
                key: "renderInterAction",
                value: function (e, t) {
                    var i = new F["default"](e, Ie.scale);
                    return i.getDom()
                }
            }, {
                ...
                value: function (e, t) {
                    t.swipeUpLock = !0;
                    var i = new window.FootballManager(e, Ie.scale, t);
                    return i.getDom()
                }
            }, {
                key: "postMsg",
                ...
                value: function (e) {
                    if (e.rendered || e.rendering) {
                        ...
                        e.rendering = !0, M["default"].send("pageLoadEnd", e.index), v["default"].log("Start rendering page ", e.index);
                        ...
                        n.css(Ie.contentsize), t.css({
                            "z-index": 999 - e.index
                        }), e.index - Ie.currentPageIndex == 1 && t.css({
                            display: "block"
                        });
                        var o = e.bgpic && "texture" === e.bgpictype;
                        if (o) i.css({
                            position: "absolute",
                            width: 640 * Ie.bgScaleRatio + "px",
                            height: 1008 * Ie.bgScaleRatio + "px",
                            overflow: "hidden",
                            "background-image": "url(" + e.bgpic + ")",
                            "background-position": "center",
                            "background-repeat": "repeat",
                            "background-size": e.bgpicsize + "%",
                            ...
                            opacity: e.opacity
                                ...
                                top: "50%",
                                left: "50%",
                                "margin-left": -320 * Ie.bgScaleRatio + "px",
                                "margin-top": -504 * Ie.bgScaleRatio + "px",
                                overflow: "hidden",
                            ...
                            if (e.bgpicCropData && !window.Config.isGif(e.bgpic && window.Config.isAppNormalMode()))(0, s["default"])(e.bgDom).css({
                                ...
                                var a = Ie.bgScaleRatio * e.bgpicwidth * (0, s["default"])(e.bgDom).context.naturalHeight / (0, s["default"])(e.bgDom).context.naturalWidth,
                                    r = 1;
                                a < document.body.clientHeight && (r = 1 + (document.body.clientHeight - a) / a), (0, s["default"])(e.bgDom).css({
                                    position: "absolute",
                                    width: Math.ceil(Ie.bgScaleRatio * e.bgpicwidth * r) + "px",
                                    top: Ie.bgScaleRatio * e.bgpictop + "px",
                                    left: Ie.bgScaleRatio * e.bgpicleft + "px",
                                    userDrag: "none",
                                    userSelect: "none",
                                    opacity: e.opacity
                                })
                        ...
                        t.append(i), t.append(n), (0, s["default"])(".maka-pages").append(t), e.MWChains = {}, e.content.map(function (t) {
                            ...
                            switch (t.type) {
                                ...
                                case "ptext":
                                    ...
                                    break;
                                case "footballManager":
                                    i = Ie.renderFootballManager(t, e);
                                    break;
                                case "pshape":
                                    i = Ie.renderShape(t);
                                    break;
                                case "btn":
                                    ...
                                    break;
                                case "pButton":
                                    i = Ie.renderSpecialButton(t);
                                    break;
                                case "eleform":
                                    i = Ie.renderFormList(t);
                                    break;
                                case "comparison":
                                    i = Ie.renderComparison(t);
                                    break;
                                case "phone_call":
                                    i = Ie.renderPhoneCall(t, e);
                                    break;
                                case "fingerPrint":
                                    i = Ie.renderFingerPrint(t, e);
                                    break;
                                case "glass_break":
                                    i = Ie.renderGlassBreak(t, e);
                                    break;
                                case "slide":
                                    i = Ie.renderSlide(t);
                                    break;
                                case "newSlide":
                                    i = Ie.renderNewSlide(t, e, Ie.scale);
                                    break;
                                case "lotteryTiger":
                                    i = Ie.renderLotteryTiger(t, e, Ie.scale);
                                    break;
                                case "lotteryScratch":
                                    i = Ie.renderLotteryScratch(t, e, Ie.scale);
                                    break;
                                case "charts":
                                    i = Ie.renderChart(t);
                                    break;
                                case "pEraser":
                                    i = Ie.renderEraser(t, e);
                                    break;
                                case "countDown":
                                    i = Ie.renderCountDown(t, e);
                                    break;
                                case "interActionButton":
                                    i = Ie.renderInterAction(t, e);
                                    break;
                                case "phoneCallButton":
                                    i = Ie.renderPhoneCallButton(t, e);
                                    break;
                                case "linkButton":
                                    i = Ie.renderLinkButton(t, e);
                                    break;
                                case "video":
                                    i = new Ie.renderVideo(t, e, Ie.scale);
                                    break;
                                case "examination":
                                    i = Ie.renderExamination(t, e);
                                    break;
                                case "answer":
                                    i = Ie.renderAnswer(t, e);
                                    break;
                                case "examConfirm":
                                    i = Ie.renderExamConfirm(t, e);
                                    break;
                                case "examChoice":
                                    i = Ie.renderExamChoice(t, Ie.scale);
                                    break;
                                case "puzzle":
                                    i = Ie.renderPuzzle(t, e, Ie.scale);
                                    break;
                                case "vote":
                                    i = Ie.renderVote(t, e, Ie.scale);
                                    break;
                                case "relay":
                                    i = Ie.renderRelay(t, e, Ie.scale);
                                    break;
                                case "newForm":
                                    i = Ie.renderNewForm(t, e, Ie.scale);
                                    break;
                                case "map":
                                    i = Ie.renderMap(t, e, Ie.scale);
                                    break;
                                case "phoneSound":
                                    i = Ie.renderPhoneSound(t, e, Ie.scale);
                                    break;
                                case "phoneLock":
                                    i = Ie.renderPhoneLock(t, e, Ie.scale);
                                    break;
                                default:
                                    Ie.setCommonCSS(t.dom, t)
                            }
                            t.dom = i, n.append(i), t.cb && t.cb(),t.class && (i.addClass(t.class), i.attr("title", t.title)),t.reportid && (i.attr("id", t.reportid))

                        }), Ie.hidePageElement(e), v["default"].log("Finish rendering page ", e.index), e.rendering = !1, e.rendered = !0
                    }
                }
            }]), e
        }(),
        je = new Ee;
    window.onresize = je.ensureCanvas, window.oncontextmenu = function (e) {
                ...
                value: function (e, t) {
                    ...
                    return console.log("ety" + e), "toup" === e ? i = (0, s["default"])(t, {
                        ...
                        startCallback: function (e, t) {
                            var i = this.dom.get(0);
                            if (!(i.style.zIndex > 1e3)) return i.style.zIndex = parseInt(i.style.zIndex) + 1e3, 0
                        }
                    }) : "effect-mf" === e ? i = new c["default"](t, {
    ...
    var a = function () {
        ...
        m = function () {
            function e(t, i, n, a) {
                o(this, e), this.scale = i, this.obj = t, this.PPT = n, this.playBtnClickType = 1, this.shareExam = d["default"].isShareExam(a), this.initDom(t, i, n)
            }
            return a(e, [{
                key: "initDom",
                value: function (e, t, i) {
                    var n = {
                        ...
                        o = (0, s["default"])("<div></div>"),
                        a = (0, s["default"])("<div></div>"),
                        r = (0, s["default"])('<div><img class="avatar" src="' + window.Config.getImgOss("images/user.png") + '" alt="ç”¨æˆ·å¤´åƒ"></div>'),
                        l = (0, s["default"])('<div class="examResult"><div class="exam-result"></div></div>'),
                        c = (0, s["default"])('<div class="lazyShow">å†çŽ©ä¸€æ¬¡</div>'),
                        u = (0, s["default"])('<div class="linkIntro"><a href="http://mp.weixin.qq.com/s?__biz=MjM5ODc3OTM5Mw==&mid=204874023&idx=1&sn=d194c99b10e9dbd1c7757a79293927fc#rd">åˆ›å»ºæˆ‘çš„æµ‹è¯•æ¸¸æˆ</a></div>');
                    o.css({
                        position: "absolute",
                        width: t(e.w),
                    ...
                    }), a.append(r), a.append(l), o.append(a), o.append(c), o.append(u), this.eleDom = o, e.showCallback = this.shareExam ? this.shareRender.bind(this) : this.afterRender.bind(this);
                    ...
                    s["default"].ajax({
                        ...
                        success: function (t) {
                            ...
                            e.eleDom.find("img").attr("src", t.data.thumb), e.eleDom.find("div.exam-result").css({
                                ...
                                color: i.fontColor
                            }).html("" + i.content), e.playBtnClickType = 1, e.eleDom.find(".lazyShow").text("æˆ‘ä¹Ÿè¦çŽ©").show(), window.projectVersion.vip_config.is_vip || e.eleDom.find(".linkIntro").show()
                        },
                        error: function (t) {
                            e.fetchInfoFail(t)
                        }
                ...
                value: function () {
                    ...
                    this.eleDom.find("div.examResult").css({
                        ...
                        color: i.fontColor
                    }), this.eleDom.find("div.exam-result").html("" + i.content), this.playBtnClickType = 2, this.eleDom.find(".lazyShow").text("å†çŽ©ä¸€æ¬¡").show(), d["default"].isWX() && (this.eleDom.find("img").attr("src", o), s["default"].ajax({
                        type: "post",
                        data: {
                            result: t,
                ...
                key: "fetchInfoFail",
                value: function (e) {
                    c["default"].error(e), this.eleDom.find("div.exam-result").html("ä¿¡æ¯èŽ·å–å¤±è´¥"), this.playBtnClickType = 1, this.eleDom.find(".lazyShow").text("æˆ‘ä¹Ÿè¦çŽ©").show(), window.projectVersion.vip_config.is_vip && this.eleDom.find(".linkIntro").show()
                }
            }]), e
        }();
    ...
    var a = function () {
        ...
        c = (n(l), function () {
            function e(t, i) {
                o(this, e), this.scale = i, this.obj = t, this.initDom(t, i)
            }
            return a(e, [{
                key: "initDom",
                value: function (e, t) {
                    ...
                    this.dayLeft = (0, s["default"])("<span></span>"), this.hourLeft = (0, s["default"])("<span></span>"), this.minLeft = (0, s["default"])("<span></span>"), this.secLeft = (0, s["default"])("<span></span>"), this.dayLeft.css(a), this.hourLeft.css(a), this.minLeft.css(a), this.secLeft.css(a), this.dayText = (0, s["default"])("<span>å¤©</span>"), this.hourText = (0, s["default"])("<span>æ—¶</span>"), this.minText = (0, s["default"])("<span>åˆ†</span>"), this.secText = (0, s["default"])("<span>ç§’</span>"), this.dayText.css(o), this.hourText.css(o), this.minText.css(o), this.secText.css(o), n.append(this.dayLeft), n.append(this.dayText), n.append(this.hourLeft), n.append(this.hourText), n.append(this.minLeft), n.append(this.minText), n.append(this.secLeft), n.append(this.secText), i.append(n), this.updateLeft(), this.startTimer(), this.eleDom = i
                }
            }, {
                key: "startTimer",
                value: function () {
    ...
    var l = function () {
        function e(t, i, n) {
            ...
            n.swipeDownLock = !0, n.swipeUpLock = !0, t.showCallback = function () {
                if (!l) {
                    var e = (0, s["default"])("<div>æ“¦ä¸€æ“¦</div>");
                    a.append(e), e.css({
                        background: "rgba(0,0,0,0.6)",
                        color: "white",
                        position: "absolute",
            ...
            w.w = 10 * parseInt(v * c / g / 10), w.h = 10 * parseInt(w.w * u / c / 10), w.x = parseInt(h * w.w / c), w.y = parseInt(p * w.w / c), this.eleDom.append(t.imgDom), (0, s["default"])(t.imgDom).eraser({
                ...
                completeFunction: function () {
                    l = !0, a.fadeOut(800, function () {
                        setTimeout(function () {
                            n.swipeDownLock = !1, n.swipeUpLock = !1, a.remove(), r.showArrow()
                        }, 1500)
                    })
                }
            }), console.log("erasor")
    ...
    var a = function () {
        ...
        u = (n(c), function () {
            function e(t, i, n) {
                o(this, e), this.obj = t, this.initDom(t, i, n)
            }
            return a(e, [{
                key: "initDom",
                value: function (e, t, i) {
                    function n() {
                        ...
                        n == i.examinationResult ? (0, s["default"])(".examination-confirm-html[data-groupid=" + t + "]").eq(0).html("ä½ å·²æµ‹è¯•ï¼ŒæŸ¥çœ‹ç»“æžœ") : (0, s["default"])(".examination-confirm-html[data-groupid=" + t + "]").eq(0).html("ç¡®å®š")
                    }
                    ...
                    o.css({
                        ...
                        fontSize: t(30),
                        color: d.aftBorder
                    }), r.append(1 == e.choiceType ? c : u), l.append(r), o.append(a), o.append(l), this.eleDom = o;
    ...
    var a = function () {
        ...
        f = function () {
            function e(t, i, n, a) {
                o(this, e), this.obj = t, this.examResultPage = -1, this.getResultPage(), this.initDom(t, i, n, a)
            }
            return a(e, [{
                key: "initDom",
                value: function (e, t, i, n) {
                    var o = this,
                        ...
                        c = (0, s["default"])('<div class="examination-confirm-html" data-groupid=' + a + ">ç¡®å®š</div>");
                    r.css({
                        position: "absolute",
                        width: i(e.w),
                        height: i(e.h),
                    ...
                    r.on(u, function () {
                        ...
                        i || (n.examinationResult = (0, s["default"])(".examination-cover.active").eq(0).data("answer"), setTimeout(function () {
                            t.swipeUpLock = !1, -1 == o.examResultPage ? n.showNextPage() : n.showPage(o.examResultPage), (0, s["default"])(e).find(".examination-confirm-html").eq(0).html("ä½ å·²æµ‹è¯•ï¼ŒæŸ¥çœ‹ç»“æžœ")
                        }, 100))
                    }), this.eleDom = r
                }
            }, {
    ...
    var a = function () {
        ...
        c = (n(l), function () {
            function e(t, i, n, a) {
                o(this, e), this.scale = i, this.obj = t, this.page = a, this.PPT = n, this.initDom(t, i, n, a)
            }
            return a(e, [{
                key: "initDom",
                value: function (e, t, i, n) {
                    ...
                    e.answers.forEach(function (e, t) {
                        ...
                        f.find("p.clicked").removeClass("clicked"), (0, s["default"])(this).addClass("clicked"), i.examinationResult[n.index] = (0, s["default"])(this).data("index") === a, o.renderStyle(), setTimeout(function () {
        ...
        g = function () {
            ...
            return a(e, [{
                ...
                value: function (e, t) {
                    ...
                    }.bind(n)), a.append(r), a.append(l), o.append(a), n.eleDom = o
                }
            }, {
                key: "_getButtonId",
                value: function () {
            ...
            return a(e, [{
                ...
                value: function (e, t) {
                    ...
                    i.css({
                        ...
                        boxShadow: "black 0px 0px " + this.obj.boxshadow + "px"
                    });
                    var a = void 0;
                    a = 0 === e.url.indexOf("http:") || 0 === e.url.indexOf("https:") ? e.url : "http://" + e.url, i.on("click", function () {
                        window.location.href = a
                    }), o.appendTo(n), n.appendTo(i), this.eleDom = i
                }
            }, {
                key: "getDom",
                value: function () {
    ...
    var a = function () {
        ...
        h = function () {
            function e(t, i, n) {
                o(this, e), this.obj = t, this.scale = i, this.page = n, this.initDom()
            }
            return a(e, [{
                key: "initDom",
                value: function () {
                    function e(e) {
                        ...
                        U.empty(), e.map(function (e) {
                            var t = (0, s["default"])("<div></div>"),
                                i = (0, s["default"])("<span></span>"),
                                n = (0, s["default"])("<span>åˆšåˆšèŽ·å¾—äº†</span>"),
                            ...
                            t.css({
                                ...
                                color: "#FF5353",
                                marginLeft: 5
                            }), n.prepend(o), n.append(a), t.append(i), t.append(n), U.append(t)
                        }), t();
                        var i = 0
                    }

                    function t() {
                        var e = E[0].getContext("2d");
                        e.globalCompositeOperation = "source-over", e.drawImage(te, 0, 0, 325, 180), e.globalCompositeOperation = "destination-out"
                    }
                    ...
                    function l(e, t, i) {
                        e.beginPath(), e.fillStyle = "#fff", e.arc(t, i, 20, 0, 2 * Math.PI, !0), e.fill()
                    }
                    ...
                    s["default"].ajax({
                        ...
                        if (t && 200 == t.code) {
                            var i = t.data;
                            v = i.total_play_times, w = i.play_times_today, b = i.prizes, y = i.records;
                            var n = g.allTimes - v,
                                o = parseInt(g.todayTimes - w) > parseInt(n) ? n : g.todayTimes - w;
                            k && (k.find(".title-num").text(n), k.find(".title-num2").text(o)), g.showWinners && y.length > 0 && e(y)
                        } else console.error(t)
                    });
                    var k = (0, s["default"])("<div>ä½ æ€»å…±è¿˜å‰©<span class='title-num'>" + v + "</span>æ¬¡æŠ½å¥–æœºä¼šï¼Œä»Šå¤©è¿˜å¯ä»¥æŠ½<span class='title-num2'>" + w + "</span>æ¬¡</div>");
                    k.css({
                        position: "absolute",
                    ...
                    var A = i(67),
                        ...
                        I = (0, s["default"])("<span>è°¢è°¢å‚ä¸Ž</span>"),
                        E = (0, s["default"])("<canvas></canvas>"),
                        j = (0, s["default"])("<div>ç‚¹å‡»å¼€å§‹</div>");
                    x.css({
                        position: "absolute",
                        width: "100%",
                        top: 0,
                    ...
                    var S = parseInt(this.scale(.9 * this.obj.w)),
                        D = parseInt(282 * S / 510);
                    P.css({
                        position: "absolute",
                        width: "90%",
                        height: D,
                        ...
                        zIndex: 2,
                        cursor: "pointer"
                    }), P.append(I), P.append(E), x.append(C), x.append(P), x.append(j), f.append(x);
                    var T = (0, s["default"])("<div></div>"),
                        O = (0, s["default"])("<div><div class='out-line'></div><div class='out-name'>ä¸­å¥–ç”¨æˆ·</div><div class='out-line'></div></div>"),
                        R = (0, s["default"])("<div></div>"),
                        U = (0, s["default"])("<div></div>"),
                        M = (0, s["default"])("<div>å½“å‰è¿˜æ²¡æœ‰äººä¸­å¥–ï¼Œå¿«æ¥è¯•è¯•ä½ çš„æ‰‹æ°”å§</div>");
                    T.css({
                        position: "absolute",
                        top: this.scale(400),
                        left: 0,
                        ...
                        background: "rgba(0,0,0,0.5)",
                        textAlign: "center"
                    }), U.append(M), g.showWinners && (R.append(U), T.append(O), T.append(R), f.append(T));
                    var z = (0, s["default"])("<div></div>"),
                        B = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>ä»Šå¤©æ²¡æœ‰æœºä¼šäº†ï¼Œä¸‹æ¬¡å†æ¥å§</div></div>"),
                        N = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>æŠ½å¥–å·²è¿‡æœŸ</div></div>"),
                        F = (0, s["default"])("<div><div class='tip-title'>æ— æ³•æŠ½å¥–</div><div class='tip-body'>è¯·åœ¨å¾®ä¿¡ä¸­æ‰“å¼€</div></div>"),
                        H = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>æ²¡æœ‰æŠ½ä¸­å‘¢ï¼Œå†æŽ¥å†åŽ‰å“Ÿ</div></div>"),
                        L = (0, s["default"])("<div>ç¡®è®¤</div>");
                    z.css({
                        position: "fixed",
                        width: "100%",
                        height: "100%",
                        ...
                        lineHeight: "2.5rem",
                        cursor: "pointer"
                    }), H.append(L), z.append(H), f.append(z);
                    var V = (0, s["default"])("<div></div>"),
                        q = (0, s["default"])("<div><div class='tip-title'>æ­å–œæ‚¨èµ¢å¾—</div></div>"),
                        J = (0, s["default"])("<div></div>"),
                        Q = (0, s["default"])("<div>è¯·å¡«å†™æ‚¨çš„ä¿¡æ¯ä»¥ä¾¿æˆ‘ä»¬è”ç³»æ‚¨</div>"),
                        W = (0, s["default"])('<input class="lottery-form" type="text" required="required" placeholder="æ‚¨çš„å§“å" />'),
                        Y = (0, s["default"])('<input class="lottery-form" type="text" required="required" placeholder="è”ç³»ç”µè¯" />'),
                        K = (0, s["default"])('<input class="lottery-form" type="text" placeholder="å¤‡æ³¨" />'),
                        G = (0, s["default"])("<div>è¯·æ­£ç¡®è¾“å…¥ä¿¡æ¯</div>"),
                        Z = (0, s["default"])("<div>æäº¤ä¿¡æ¯</div>"),
                        X = (0, s["default"])("<div><div class='tip-title2'>ä¿¡æ¯å·²æäº¤</div><div class='tip-body2'>è¯·è€å¿ƒç­‰å€™ï¼Œæˆ‘ä»¬çš„å®¢æœä¼šè·Ÿæ‚¨è”ç³»å‘å¥–äº‹å®œ</div></div>"),
                        _ = (0, s["default"])("<div>ç¡®è®¤</div>");
                    V.css({
                        position: "fixed",
                        width: "100%",
                        height: "100%",
                        ...
                        lineHeight: "2.5rem",
                        cursor: "pointer"
                    }), q.append(J), q.append(Q), q.append(W), q.append(Y), q.append(K), q.append(G), q.append(Z), V.append(q), X.append(_), V.append(X), f.append(V);
                    var $ = i(49),
                        ee = E[0].getContext("2d"),
                        te = new Image;
                    te.src = $, setTimeout(function () {
                        ee.drawImage(te, 0, 0, 325, 180), ee.globalCompositeOperation = "destination-out"
                    }, 800);
                    var ie = !1,
                        ne = !0;
                    E.on("touchstart mousedown", function (e) {
                        if (!ne) {
                            e.preventDefault(), e.stopPropagation(), ie = !0;
                            var t = E[0].getBoundingClientRect().left,
                                i = E[0].getBoundingClientRect().top,
                                o = e.originalEvent ? e.originalEvent.touches ? e.originalEvent.touches[0] : e.originalEvent : e;
                            l(ee, o.clientX - t, o.clientY - i), u(ee, S, D) > 70 && (ne = !0, n(m))
                        }
                    ...
                    j.on(oe, function () {
                        return p["default"].isWX() ? g.deadlineTime < Date.parse(new Date) ? (z.empty(), N.append(L), z.append(N), z.css({
                            ...
                            if (e && 200 == e.code) {
                                ...
                                if (k && (k.find(".title-num").text(n), k.find(".title-num2").text(a)), I.empty(), 1 == i.is_win) {
                                    ...
                                    r.css({
                                        ...
                                        "letter-spacing": 0,
                                        lineHeight: "40px"
                                    }), c.append(r), c.append(l), I.append(c);
                                    ...
                                    u.css({
                                        ...
                                        fontSize: "1rem",
                                        margin: "0.5rem 0"
                                    }), J.empty(), J.append(u), J.append(d), m = !0
                                } else I.text("è°¢è°¢å‚ä¸Ž"), m = !1, z.empty(), H.append(L), z.append(H), L.on(oe, function () {
                                    t(), z.css({
                                        "pointer-events": "none",
                                        opacity: 0
                                    }), j.css({
                            ...
                            } else console.error("getResultInfo", e), alert(e.error)
                        ...
                        t.test(i) ? e.test(n) ? (G.css({
                            ...
                            e && 200 == e.code ? r() : (G.text(e.message), G.css({
                                opacity: 1
                            }), console.error("setPersonalInfo", e))
                        })) : (G.text("è¯·æ­£ç¡®è¾“å…¥è”ç³»æ‰‹æœº"), G.css({
                            opacity: 1
                        })) : (G.text("è¯·è¾“å…¥åå­—"), G.css({
                            opacity: 1
                        }))
                    }), _.on(oe, function () {
                        t(), V.css({
        ...
        return a(e, [{
            ...
            value: function () {
                function e(e) {
                    ...
                    U.empty(), e.map(function (e) {
                        ...
                        t.css({
                            ...
                            color: "#FF5353",
                            marginLeft: 5
                        }), n.prepend(o), n.append(r), t.append(i), t.append(n), U.append(t)
                    }), t();
                    var i = 0
                }
                ...
                s["default"].ajax({
                    ...
                    if (t && 200 == t.code) {
                        var i = t.data;
                        f = i.total_play_times, h = i.play_times_today, g = i.prizes, m = i.records;
                        var n = r.allTimes - f,
                            o = parseInt(r.todayTimes - h) > parseInt(n) ? n : r.todayTimes - h;
                        w && (w.find(".title-num").text(n), w.find(".title-num2").text(o)), m.length > 0 && r.showWinners && e(m)
                    } else console.error(t)
                });
                var w = (0, s["default"])("<div>ä½ æ€»å…±è¿˜å‰©<span class='title-num'>" + f + "</span>æ¬¡æŠ½å¥–æœºä¼šï¼Œä»Šå¤©è¿˜å¯ä»¥æŠ½<span class='title-num2'>" + h + "</span>æ¬¡</div>");
                w.css({
                    position: "absolute",
                    width: "100%",
                    height: this.scale(35),
                ...
                var b = i(68),
                    ...
                    I = (0, s["default"])('<div><div style="margin-top: 10px;">ç‚¹<br>å‡»<br>å¼€<br>å§‹</div></div>');
                k.css({
                    position: "absolute",
                    top: this.scale(90),
                    left: 0,
                ...
                x.css({
                    ...
                    backgroundSize: "contain",
                    backgroundRepeat: "repeat-y"
                }), A.append(x), A.append(C), A.append(P), k.append(A), k.append(I), o.append(k);
                var T = (0, s["default"])("<div></div>"),
                    O = (0, s["default"])("<div><div class='out-line'></div><div class='out-name'>ä¸­å¥–ç”¨æˆ·</div><div class='out-line'></div></div>"),
                    R = (0, s["default"])("<div></div>"),
                    U = (0, s["default"])("<div></div>"),
                ...
                T.css({
                    ...
                    background: "rgba(0,0,0,0.5)",
                    textAlign: "center"
                }), U.append(M), r.showWinners && (R.append(U), T.append(O), T.append(R), o.append(T));
                var z = 0,
                    B = "ontouchend" in document ? "touchstart" : "click";
                I.on(B, function () {
                    if (!u) {
                        if (!p["default"].isWX()) return N.empty(), L.append(q), N.append(L), N.css({
                            "pointer-events": "auto",
                            opacity: 1
                        }), void q.on(B, function () {
                            N.css({
                                "pointer-events": "none",
                                opacity: 0
                            })
                        });
                        if (r.deadlineTime < Date.parse(new Date)) return N.empty(), H.append(q), N.append(H), N.css({
                            "pointer-events": "auto",
                            opacity: 1
                        }), void q.on(B, function () {
                            N.css({
                        ...
                        if (parseInt(w.find(".title-num2").text()) <= 0) return N.empty(), F.append(q), N.append(F), N.css({
                            "pointer-events": "auto",
                            opacity: 1
                        }), void q.on(B, function () {
                            N.css({
                            ...
                            if (e && 200 == e.code) {
                                ...
                                if (w && (w.find(".title-num").text(n), w.find(".title-num2").text(a)), 1 == i.is_win) {
                                    ...
                                    c.css({
                                        ...
                                        fontSize: "1rem",
                                        margin: "0.5rem 0"
                                    }), W.empty(), W.append(c), W.append(u)
                                } else l = !1, v ? D = D + 4 * j - 2 * E : D += 4 * j, v = !1, N.empty(), V.append(q), N.append(V), q.on(B, function () {
                                    N.css({
                                        "pointer-events": "none",
                                        opacity: 0
                                    })
                ...
                var N = (0, s["default"])("<div></div>"),
                    F = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>ä»Šå¤©æ²¡æœ‰æœºä¼šäº†ï¼Œä¸‹æ¬¡å†æ¥å§</div></div>"),
                    H = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>æŠ½å¥–å·²è¿‡æœŸ</div></div>"),
                    L = (0, s["default"])("<div><div class='tip-title'>æ— æ³•æŠ½å¥–</div><div class='tip-body'>è¯·åœ¨å¾®ä¿¡ä¸­æ‰“å¼€</div></div>"),
                    V = (0, s["default"])("<div><div class='tip-title'>å¾ˆé—æ†¾</div><div class='tip-body'>æ²¡æœ‰æŠ½ä¸­å‘¢ï¼Œå†æŽ¥å†åŽ‰å“Ÿ</div></div>"),
                    q = (0, s["default"])("<div>ç¡®è®¤</div>");
                N.css({
                    position: "fixed",
                    width: "100%",
                    height: "100%",
                    ...
                    lineHeight: "2.5rem",
                    cursor: "pointer"
                }), V.append(q), N.append(V), o.append(N);
                var J = (0, s["default"])("<div></div>"),
                    Q = (0, s["default"])("<div><div class='tip-title'>æ­å–œæ‚¨èµ¢å¾—</div></div>"),
                    W = (0, s["default"])("<div></div>"),
                    Y = (0, s["default"])("<div>è¯·å¡«å†™æ‚¨çš„ä¿¡æ¯ä»¥ä¾¿æˆ‘ä»¬è”ç³»æ‚¨</div>"),
                    K = (0, s["default"])('<input class="lottery-form" type="text" required="required" placeholder="æ‚¨çš„å§“å" />'),
                    G = (0, s["default"])('<input class="lottery-form" type="text" required="required" placeholder="è”ç³»ç”µè¯" />'),
                    Z = (0, s["default"])('<input class="lottery-form" type="text" placeholder="å¤‡æ³¨" />'),
                    X = (0, s["default"])("<div>è¯·æ­£ç¡®è¾“å…¥ä¿¡æ¯</div>"),
                    _ = (0, s["default"])("<div>æäº¤ä¿¡æ¯</div>"),
                    $ = (0, s["default"])("<div><div class='tip-title2'>ä¿¡æ¯å·²æäº¤</div><div class='tip-body2'>è¯·è€å¿ƒç­‰å€™ï¼Œæˆ‘ä»¬çš„å®¢æœä¼šè·Ÿæ‚¨è”ç³»å‘å¥–äº‹å®œ</div></div>"),
                    ee = (0, s["default"])("<div>ç¡®è®¤</div>");
                J.css({
                    position: "fixed",
                    width: "100%",
                    height: "100%",
                    ...
                    lineHeight: "2.5rem",
                    cursor: "pointer"
                }), Q.append(W), Q.append(Y), Q.append(K), Q.append(G), Q.append(Z), Q.append(X), Q.append(_), J.append(Q), $.append(ee), J.append($), o.append(J), _.on(B, function () {
                    var e = /^1(3|4|5|8)[0-9]{9}$/,
                        t = /.+/,
                        i = K[0].value,
                        o = G[0].value,
                    ...
                    })) : (X.text("è¯·æ­£ç¡®è¾“å…¥è”ç³»æ‰‹æœº"), X.css({
                        opacity: 1
                    })) : (X.text("è¯·è¾“å…¥åå­—"), X.css({
                        opacity: 1
                    }))
                }), ee.on(B, function () {
                    J.css({
    ...
    var a = function () {
        ...
        u = function () {
            function e(t, i) {
                o(this, e), this.obj = t, this.scale = i, this.eleDom = this.initDom()
            }
            return a(e, [{
                key: "initDom",
                value: function () {
                    ...
                    }), r.append("å¯¼èˆª"), t.append(o), t.append(a), t.append(r);
    ...
    var a = function () {
        ...
        u = function () {
            function e(t, i) {
                o(this, e), this.obj = t, this.scale = i, this.btns = [], this.selectBtn = [], this.radios = [], this.inputs = [], this.tips = [], this.requires = {}, this.errorTips = [], this.eleDom = this.initDom(), this.answers = [], this.radiosAnswers = {}
            }
            return a(e, [{
                key: "doValidateInputs",
                value: function () {
                    if (!this.obj.inputs) return !0;
                    this.errorTips = [], this.answers = [];
                    for (var e = !0, t = 0; t < this.obj.inputs.length; t++) {
                        var i = this.obj.inputs[t],
                            n = "",
                            o = this.inputs[t].val().replace(/^\s\s*/, "").replace(/\s\s*$/, "");
                        if (this.answers.push(o), i.require && "" == o) n = "è¯·å¡«å†™ " + i.str, e = !1, this.inputs[t].val("");
                        else if ("" != o) {
                            var a = !0;
                            ...
                            a || (n = "è¯·å¡«å†™ æ­£ç¡®æ ¼å¼", e = !1, this.inputs[t].val(""))
                        }
                        this.errorTips.push(n), n ? (this.tips[t].empty(), this.requires[t] && this.requires[t].empty(), this.tips[t].append(n), this.inputs[t].css({
                ...
                value: function () {
                    ...
                    var e = !0;
                    this.radiosAnswers = {};
                    for (var t = 0; t < this.obj.single.length; t++)
                        for (var i = this.obj.single[t].radio, n = 0; n < i.length; n++) {
                ...
                value: function () {
                    ...
                    if (this.obj.single)
                        for (var a = function (t) {
                                e.selectBtn.push(-1), e.btns.push([]);
                                ...
                                if (a.radio)
                                    for (var c = function (r) {
                                            ...
                                            d.css({
                                                ...
                                                boxSizing: "border-box"
                                            }), e.btns[t].push(d), l.on(o, function () {
                                                d.css({
                    ...
                    if (this.obj.inputs)
                        for (var l = function (t) {
                                ...
                                var r = void 0;
                                r = o.textArea ? (0, s["default"])("<textarea></textarea>") : "date" == o.regularType ? (0, s["default"])("<input type=date>") : (0, s["default"])("<input>"), r.css({
                                    position: "absolute",
                                    outline: "none",
                                    textIndent: "1em",
                                    fontSize: e.scale(28),
                                ...
                                l.css({
                                    ...
                                    pointerEvents: "none",
                                    opacity: .7
                                }), l.append(o.str), e.tips.push(l), a.append(l);
                                var c = void 0;
                                o.require && (c = (0, s["default"])("<span></span>"), c.css({
                                    ...
                                    pointerEvents: "none",
                                    lineHeight: e.scale(o.lineHeight)
                                }), c.append("*"), a.append(c), e.requires[t] = c), r.on("focus", function () {
                                    var e = r.val().replace(/^\s\s*/, "").replace(/\s\s*$/, "");
                                    e || r.val(""), l.empty(), c && c.empty(), n.errorTips[t] && (n.errorTips[t] = void 0)
                                }), r.on("blur", function () {
                                    var e = r.val().replace(/^\s\s*/, "").replace(/\s\s*$/, "");
                    ...
                    return this.obj.submit && ! function () {
                        var t = e.obj.submit,
                            a = (0, s["default"])("<div></div>");
                        a.css({
                            position: "absolute",
                        ...
                        a.on(o, function () {
                            if (!r) {
                                if (n.doValidateInputs() && n.doValidateRadio()) {
                                    ...
                                    e.content = JSON.stringify(e.content), r = !0, s["default"].ajax({
                                        type: "post",
                                        ...
                                        success: function () {
                                            a.css({
                                                background: "gray"
                                            }), a.empty(), a.unbind(), a.append(t.beforeStr)
                                        },
                                        error: function () {},
                                        always: function () {
                                            r = !1
    ...
    var h = function () {
        function e(t, i, n) {
            o(this, e), this.obj = t, this.scale = i, this.page = n, this.eleDom = void 0, this.onPageFun = void 0, this.initDom()
        }
        return a(e, [{
            key: "initDom",
            value: function () {
                ...
                o.data.map(function (e, o) {
                    var l = (0, s["default"])("<li class='swipe-slide-" + o + "'></li>"),
                        d = (0, s["default"])("<div></div>"),
                        f = (0, s["default"])("<button class='" + (0 === o ? "un-nav-item un-nav-item-current" : "un-nav-item") + "'></button>");
                    l.css(c["default"].obj_assign({
                        position: "absolute",
                        top: 0,
                        left: 0,
                        width: u,
                    ...
                    }), l.append(d), i.append(f), a.push(l), r.push(f), t.append(l)
                }), e.append(t), e.append(i), this.eleDom = e;
                var b = function () {
                        if (!(l >= a.length - 1)) {
                            ++l;
                            var e = a[l],
                                t = a[l - 1],
                                i = a[l + 1];
                            e.css(w.current), r[l].addClass("un-nav-item-current"), r[l - 1].removeClass("un-nav-item-current"), t && t.css(w.left), i && i.css(w.right)
                        }
                    },
                    y = function () {
                        if (!(0 >= l)) {
                    ...
                    k = !0,
                    A = function C() {
                        if (k) l >= a.length - 1 && (k = !1), setTimeout(function () {
                            b(), C()
                        }, 1e3 * o.transitonTime);
                        else {
                            if (0 === l) return k = !0, void y();
                            setTimeout(function () {
                                y(), C()
                            }, 10)
                        }
                ...
                x.on("swipeleft", b), x.on("swiperight", y)
            }
        }, {
            key: "getDom",
            value: function () {
        ...
        c = (n(l), function () {
            ...
            return a(e, [{
                ...
                value: function (e, t) {
                    ...
                    }), o.append(l), o.append(c), n.append(o), this.eleDom = n
                }
            }, {
                key: "getDom",
                value: function () {
    ...
    var a = function () {
        ...
        d = (n(u), function () {
            function e(t, i, n) {
                o(this, e), this.obj = t, this.scale = i, this.bgscale = n, this.msDom = void 0, this.dateDom = void 0, this.messageDiv = void 0, this.eleDom = this.initDom()
            }
            return a(e, [{
                key: "fixDate",
                value: function (e) {
                ...
                value: function () {
                    ...
                    g.css({
                        ...
                        whiteSpace: "nowrap"
                    }), g.text(this.obj.messageDiv.inDiv.messageTitle.str), d.append(g);
                    ...
                    v.css({
                        ...
                        pointerEvents: "none"
                    }), v.text(this.obj.messageDiv.message.str), l.append(v);
                    ...
                    return w.css({
                        ...
                        pointerEvents: "none"
                    }), w.text("æ»‘åŠ¨æŸ¥çœ‹æ›´å¤š"), l.append(w), t.append(l), this.messageDiv = l, this.setTimer(), e
                }
            }, {
                key: "animateToNext",
                value: function (e) {
    ...
    var a = function () {
        ...
        d = (n(u), function () {
            function e(t, i, n) {
                o(this, e), this.obj = t, this.scale = i, this.bgscale = n, this.time = 0, this.timeDom = void 0, this.timer = void 0, this.hangup = void 0, this.eleDom = this.initDom()
            }
            return a(e, [{
                key: "initDom",
                value: function () {
                    ...
                    a.css({
                        ...
                        textAlign: "center",
                        whiteSpace: "nowrap"
                    }), a.append(this.obj.callerSrc.text), t.append(a);
                    var r = (0, s["default"])("<div></div>");
                    r.css({
                        position: "absolute",
                        ...
                        textAlign: "center"
                    }), r.append("00:00"), this.timeDom = r, t.append(r);
                    ...
                    }), u.append(d), t.append(u), this.hangup = d, e
                }
            }, {
                key: "start",
                value: function () {
    ...
    var r = function () {
        ...
        p = function (e) {
            function t(e, i) {
                o(this, t), s(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, e, i)
            }
            return a(t, e), r(t, [{
                key: "_getShowSwipe",
                value: function (e) {
                        ...
                        if (0 === this.percent) var e = setInterval(function () {
                            if (this.showPreload) {
                                var t = parseInt(360 * this.percent),
                                    i = this;
                                t <= this.degree && this.degree < 359 ? this.degree += .01 : 360 === t ? this.degree += 20 : t - this.degree > 180 ? this.degree += 2 : t - this.degree > 40 ? this.degree += 1 : t - this.degree < 10 && 330 > t ? this.degree += 1 : t > this.degree && (this.degree += .5), this.degree > 360 && (this.degree = 360, clearInterval(e), d["default"].send("homeEnd"),
                                    p["default"].isTemplate() && !p["default"].isRemoveDesignerAd(), setTimeout(function () {
                                        i.callback()
        ...
        h = function () {
            ...
            return a(e, [{
                ...
                value: function (e, t) {
                    var i = e[t],
                        n = i.length;
                    return "0" === i[n - 1] && "/" === i[n - 2] && (i = i.slice(0, n - 1) + "64", e[t] = i), i
                }
            }, {
                key: "initDom",
                value: function () {
                    ...
                    if (t.css({
                        ...
                        a.append(r), n.append(a), this.setRealWidth(a, o)
                    }
                    if (this.obj.cnts) {
                        var l = this.obj.cnts,
                            u = (0, s["default"])("<div></div>");
                    ...
                    if (this.obj.btn && ! function () {
                            ...
                            i.css({
                                ...
                                i.on(n, function () {
                                    ...
                                    }), i.unbind(), i.empty(), i.append(t.relayedStr || "å·²æŽ¥åŠ›")
                                })
    ...
    var a = function () {
        ...
        m = function () {
            function e(t, i) {
                o(this, e), this.obj = t, this.scale = i, this._prepareElements()
            }
            return a(e, [{
                key: "_prepareElements",
                value: function () {
                    ...
                    if (t.css({
                        ...
                        switch (a.css({
                            ...
                            case "link":
                                ...
                                break;
                            case "phone":
                                o.text(this.obj.con), this.obj.phoneNumber && i.attr("href", "tel:" + this.obj.phoneNumber);
                                break;
                            case "interaction":
                                var r = this,
                                    l = function () {
                        ...
                        if (m = new Date, v = m.getTime(), j - v > 0) {
                            u = Math.floor((j - v) / P), f = Math.floor((j - v) / C) % 24, h = Math.floor((j - v) / x) % 60, g = Math.floor((j - v) / A) % 60, w.append(10 > u ? "0" + u : u), b.append(10 > f ? "0" + f : f), y.append(10 > h ? "0" + h : h), k.append(10 > g ? "0" + g : g), i.append(w), i.append((0, s["default"])('<span class="timeSpace">:</span>')), i.append(b), i.append((0, s["default"])('<span class="timeSpace">:</span>')), i.append(y), i.append((0, s["default"])('<span class="timeSpace">:</span>')), i.append(k);
                            var S = setInterval(function () {
                                v += 1e3, j - v ? (u = Math.floor((j - v) / P), f = Math.floor((j - v) / C) % 24, h = Math.floor((j - v) / x) % 60, g = Math.floor((j - v) / A) % 60, window.document.getElementById("day").innerHTML = 10 > u ? "0" + u : u, window.document.getElementById("hour").innerHTML = 10 > f ? "0" + f : f, window.document.getElementById("minute").innerHTML = 10 > h ? "0" + h : h, window.document.getElementById("second").innerHTML = 10 > g ? "0" + g : g) : clearInterval(S)
                            }, 1e3)
    ...
    var a = function () {
        ...
        u = function () {
            function e(t, i) {
                o(this, e), this.scale = i, this.obj = t, this.initDom()
            }
            return a(e, [{
                key: "initDom",
                value: function () {
                    ...
                    o.append(e), n.append(o), this.eleDom = n
                }
            }, {
                key: "getElement",
                value: function () {
        ...
        c = (n(l), function () {
            ...
            return a(e, [{
                ...
                value: function (e, t) {
                    ...
                    if (0 === e.urlCon.indexOf("http:") || 0 === e.urlCon.indexOf("https:")) this.urlCon = e.urlCon.replace(/\@/g, "");
                    else {
    ...
    var a = function () {
        ...
        h = function () {
            function e(t, i) {
                o(this, e), this.obj = t, this.scale = i, this.eleDom = void 0, this.btnOptionDom = void 0, this.ticketDom = void 0, this.option = {}, this.allData = p["default"].voteData ? p["default"].voteData : {};
                try {
                ...
                value: function () {
                    ...
                    if (this.obj.pic) {
                        var u = this.obj.pic,
                            ...
                            h = void 0,
                            g = void 0;
                        u.cropData && !window.Config.isGif(u.picid) && window.Config.isAppNormalMode() ? (g = f, p = 0, h = 0) : (g = "auto" === u.inw || 0 === u.inw ? f : this.scale(u.inw), p = this.scale(u.intop), h = this.scale(u.inleft)), o = (0, s["default"])("<div></div>"), o.css({
                            position: "absolute",
                            overflow: "hidden",
                            left: "0px",
                            top: "0px",
                    ...
                    if (this.obj.ticketOption) {
                        ...
                        var w = (this.option.vote_option_sum || 0) + "ç¥¨";
                    ...
                    this.obj.btnOption && ! function () {
                        ...
                        l = (0, s["default"])('<div class="vote-btn"></div>'), l.css({
                            ...
                            "background-color": r
                        }), n ? l.append(t.str) : l.append("å·²ç»“æŸ"), i.append(l), o && ! function () {
                            ...
                            l.on(i, function () {
                                ...
                                }), l.unbind(), l.empty(), l.append(t.beforeStr || "å·²æŠ•ç¥¨");
    ...
    var a = function () {
        ...
        s = (n(r), function () {
            function e(t, i) {
                o(this, e), this.dom = t, this.options = i, this.domTimer = !1, this.cssChange = !1, this.manualValue = 0, this.preManualValue = 0, this.css = {}, this.startTime = void 0, this.finishCb = void 0, this.setIinitState(), this.start(), this.loop = 0
            }
            return a(e, [{
                key: "start",
                value: function () {
                    var e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
                            return setTimeout(e, 1e3 / 60)
                        },
                        t = this,
                        i = function n(i) {
                            ...
                            if (t.preManualValue != t.manualValue && (t.setCss(t.manualValue), t.preManualValue = t.manualValue), void 0 == t.startTime || (new Date).getTime() <= t.startTime + t.options.duration) e(n);
                                ...
                                var o = t.dom.get(0);
                                try {
                                    o.style.transformOrigin = "", o.style.transform = "", o.style.transition = ""
                                } catch (a) {
                                    console.error(a)
                                }
                                t.finishCb && t.finishCb(), window.pageEffectRuning = !1
                            }
                        };
                    e(i)
                }
                ...
                value: function () {
                    ...
                    if (t.perspective && (i += "perspective(" + t.perspective + "px) "), t.position) {
                        var n = [];
                        n.push(t.fromPosition[0] + (t.position[0] - t.fromPosition[0]) * e), n.push(t.fromPosition[1] + (t.position[1] - t.fromPosition[1]) * e), n.push(t.fromPosition[2] + (t.position[2] - t.fromPosition[2]) * e), i += "translate(" + n[0] + "px, " + n[1] + "px) "
                    }
                    if (t.rotation) {
                        var n = [];
                        n.push(t.fromRotation[0] + (t.rotation[0] - t.fromRotation[0]) * e), n.push(t.fromRotation[1] + (t.rotation[1] - t.fromRotation[1]) * e), n.push(t.fromRotation[2] + (t.rotation[2] - t.fromRotation[2]) * e);
                ...
                value: function (e) {
                    ...
                    this.manualValue = 1, this.startTime = (new Date).getTime(), this.finishCb = e
                }
            }, {
                key: "setValue",
                value: function (e) {
        ...
        var t = {
            ...
            touchStart: function (i) {
                ...
                if (!o.touchDown) {
                    var a = i.originalEvent.changedTouches[0],
                        r = a.pageX - o.posX,
                        s = a.pageY - o.posY;
                    r *= o.scaleRatio, s *= o.scaleRatio, t.evaluatePoint(o, r, s), o.touchDown = !0, o.touchID = a.identifier, o.touchX = r, o.touchY = s, i.preventDefault()
                }
            },
            touchMove: function (i) {
                var n = e(this),
                    o = n.data("eraser");
                if (o.touchDown)
                    for (var a = i.originalEvent.changedTouches, r = a.length; r--;)
                        if (a[r].identifier == o.touchID) {
                            var s = a[r].pageX - o.posX,
                                l = a[r].pageY - o.posY;
                            s *= o.scaleRatio, l *= o.scaleRatio, t.evaluatePoint(o, s, l), o.ctx.beginPath(), o.ctx.moveTo(o.touchX, o.touchY), o.touchX = s, o.touchY = l, o.ctx.lineTo(o.touchX, o.touchY), o.ctx.stroke(), n.css({
            ...
            touchEnd: function (t) {
                var i = e(this),
                    n = i.data("eraser");
                if (n.touchDown)
                    for (var o = t.originalEvent.changedTouches, a = o.length; a--;)
                        if (o[a].identifier == n.touchID) {
            ...
            mouseDown: function (i) {
                var n = e(this),
                    ...
                    a = i.pageX - o.posX,
                    r = i.pageY - o.posY;
                a *= o.scaleRatio, r *= o.scaleRatio, t.evaluatePoint(o, a, r), o.touchDown = !0, o.touchX = a, o.touchY = r, o.ctx.beginPath(), o.ctx.moveTo(o.touchX - 1, o.touchY), o.ctx.lineTo(o.touchX, o.touchY), o.ctx.stroke(), n.bind("mousemove.eraser", t.mouseMove), e(document).bind("mouseup.eraser", o, t.mouseUp), i.preventDefault()
            },
            mouseMove: function (i) {
                var n = e(this),
                    ...
                    a = i.pageX - o.posX,
                    r = i.pageY - o.posY;
                a *= o.scaleRatio, r *= o.scaleRatio, t.evaluatePoint(o, a, r), o.ctx.beginPath(), o.ctx.moveTo(o.touchX, o.touchY), o.touchX = a, o.touchY = r, o.ctx.lineTo(o.touchX, o.touchY), o.ctx.stroke(), n.css({
                    "z-index": n.css("z-index") == o.zIndex ? parseInt(o.zIndex) + 1 : o.zIndex
                }), i.preventDefault()
            },
            mouseUp: function (t) {
    ...
    function r(e) {
        delete e.height, e.rotate = parseInt(e.rotate), e.shape && "0" !== e.shape || (e.shape = "1.svg"), e.shape.indexOf("/SVG/") < 0 && e.shape.indexOf("<svg") < 0 && (e.shape = "svg/Default/SVG/" + e.shape), e.h = e.h < 0 ? 0 : e.h, e.shapecolor && (e.colorScheme = {
            color1: e.shapecolor
        }, delete e.shapecolor)
    }
    ...
    t["default"] = function (e) {
                ...
                n = function (e) {
                    ...
                    switch (n.type) {
                        ...
                        case "puzzle":
                            ...
                            break;
                        case "vote":
                            u["default"].setNeedWxLogin(!0), u["default"].hasVote = !0;
                            break;
                        case "lotteryTiger":
                        ...
                        case "lotteryCycle":
                            ...
                            break;
                        case "relay":
                            u["default"].setNeedWxLogin(!0), t > 0 && h["default"].getCookie(window.Config.wxCookie) && s(n.relayId).then(function (e) {
        ...
        return u["default"].isExam(e) && u["default"].isShareExam(e) && (e = o(e)), e
    }, e.exports = t["default"]
}, function (e, t) {}, 52, 52, 52, function (e, t, i) {
    "use strict";
    var n = i(5);
    ...
    o.resolve = function (e) {
        ...
        return new o(function (e, i) {
            ...
            for (var a = t.length, r = 0; r < t.length; r++) n(r, t[r])
        })
    }, o.reject = function (e) {
    ...
    "use strict";
    e.exports = i(5), i(56), i(58), i(57), i(60), i(61)
}, function (e, t, i) {
    "use strict";
            ...
            return a(e, [{
                ...
                value: function () {
                    ...
                    k.css({
                        ...
                        var e = 102;
                        g["default"].send("makaAD", e), window.statisticSDK.countTailAd(), window.location.href = d.url
                    }), y.append(k);
                    var A = (0, s["default"])("<div>è¿”å›ž</div>");
                    A.css({
                        position: "absolute",
                    ...
                    var x = (0, s["default"])("<div>ä¸¾æŠ¥</div>");
                    x.css({
                        position: "absolute",
                        top: p["default"].scale(46),
                    ...
                    var C = (0, s["default"])('<img src="' + i(103) + '" alt="" />');
                    C.css({
                        position: "absolute",
                    ...
                    }), x.prepend(C), o.append(A), o.append(x), o.append(a), o.append(r), o.append(l), o.append(u), (window.projectVersion.vip_config.show_makalogo || !v["default"].isStoreTemplatePreview() && v["default"].isTemplate()) && o.append(y), x.on(w, function () {
                        e.showReport()
                    })
                }
            }, {
                ...
                value: function () {
                    ...
                    function n() {
                        ...
                        l ? (n = (0, s["default"])('\n        <div style="position:absolute;left:50%;margin-left:-154px;top:30%;width:285px;color:#fff;background:rgba(0,0,0,0.4);border-radius:10px;line-height: 25px;padding:10px;">\n          æ‚¨çš„ä¸¾æŠ¥ä¿¡æ¯æˆ‘ä»¬å·²ç»æ”¶åˆ°ï¼Œæˆ‘ä»¬ä¼šå°½å¿«å®¡æ ¸ï¼Œæ„Ÿè°¢æ‚¨çš„æ”¯æŒ\n        </div>\n        '), a.append(n), setTimeout(function () {
                            ...
                            success: function () {
                                p["default"].setCookie("report_" + r, "1", 365), a.append(n), setTimeout(function () {
                                    n.fadeOut(1e3, function () {
                                        t()
                                    })
                                }, 1e3)
                    ...
                    var c = (0, s["default"])("<div>é€‰æ‹©ä¸¾æŠ¥ç±»åž‹</div>");
                    c.css({
                    ...
                    for (var f = ["è‰²æƒ…", "è¯ˆéª—", "è°£è¨€", "åžƒåœ¾å¹¿å‘Š", "æ”¿æ²»æ•æ„Ÿ", "ä¾µæƒï¼ˆæŠ„è¢­å†’ç”¨", "å…¶ä»–"], h = "", g = 0; g < f.length; g++) {
                        var m = i(99),
                            b = i(102),
                        ...
                        y.on(w, function () {
                            h = (0, s["default"])(this).text(), r.find(".reportType").each(function () {
                    ...
                    var k = (0, s["default"])('\n      <div style="font-size:' + p["default"].scale(24) + ";background:gray;color:white;text-align:center;line-height:" + p["default"].scale(76) + ";height:" + p["default"].scale(76) + ";margin:" + p["default"].scale(20) + " " + p["default"].scale(40) + '">æäº¤</div>\n      ');
                    r.append(k), l.show(), r.show(), a.append(l), a.append(r), l.on(w, function () {
                        t()
                    });
                    var A = !1
                }
            ...
            return a(e, [{
                ...
                value: function () {
                    ...
                    e.fadeIn(), (0, c["default"])(e, "stop"), e.css({
                        ...
                        opacity: 1,
                        top: "0px"
                    }), e.attr("page-showded", "true"), (0, s["default"])(".maka-pages").eq(0).css({
                        "-webkit-filter": "blur(8px)"
                ...
                value: function () {
                    ...
                    var t = (0, s["default"])("#all-banner");
                    t.fadeIn(), e.removeAttr("page-showded")
                }
            }]), e
        }(),
        p = new f;
    window.finalAdPage = p, t["default"] = p, e.exports = t["default"]
}, , , , , , , function (e, t) {
